...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-tuition-fees.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:26 GMT -->
<head>
   <meta charset="utf-8">
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Tuition & Fees</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">Tuition & Fees</h3>
               </div>
            </div>
         </div>
      </div>
                          ...
                          <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                              <div class="tp-tution-body">
                                 <div class="tp-tution-table mb-50">
                                    ...
                                    <ul>
                                       ...
                                       <li class="tp-tution-table-inner">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                                <h4 class="tp-tution-inner">Tuition Fees</h4>
                                             </div>
                                             <div class="tp-tution-sub">
                                                <h4 class="tp-tution-inner">$4,860</h4>
                                             </div>
                                             <div class="tp-tution-type">
                                                <h4 class="tp-tution-inner">$14,860</h4>
                                             </div>
                                          </div>
                                       </li>
                                       <li class="tp-tution-table-inner">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                                <h4 class="tp-tution-inner">Enrollment Fee</h4>
                                             </div>
                                             <div class="tp-tution-sub">
                                                <h4 class="tp-tution-inner">$1,860</h4>
                                             </div>
                                             <div class="tp-tution-type">
                                                <h4 class="tp-tution-inner">$8,860</h4>
                                             </div>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                                 <div class="tp-tution-table">
                                    <h4 class="tp-tution-main-title">International Fees</h4>
                                    <ul>
                                       <li class="tp-tution-table-head">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                       ...
                                       <li class="tp-tution-table-inner">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                                <h4 class="tp-tution-inner">Related Costs</h4>
                                             </div>
                                             <div class="tp-tution-sub">
                                                <h4 class="tp-tution-inner">$2400</h4>
                                             </div>
                                             <div class="tp-tution-type">
                                                <h4 class="tp-tution-inner">$4600</h4>
                                             </div>
                                          </div>
                                       </li>
                                       <li class="tp-tution-table-inner">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                                <h4 class="tp-tution-inner">Insurance</h4>
                                             </div>
                                             <div class="tp-tution-sub">
                                                <h4 class="tp-tution-inner">$860</h4>
                                             </div>
                                             <div class="tp-tution-type">
                                                <h4 class="tp-tution-inner">$1260</h4>
                                             </div>
                                          </div>
                                       </li>
                                       <li class="tp-tution-table-inner none">
                                          <div class="tp-course-table-row">
                                             <div class="tp-tution-id">
                                                <h4 class="tp-tution-inner">Enrolment Fee</h4>
                                             </div>
                                             <div class="tp-tution-sub">
                                                <h4 class="tp-tution-inner">$200</h4>
                                             </div>
                                             <div class="tp-tution-type">
                                                <h4 class="tp-tution-inner">$800</h4>
                                             </div>
                                          </div>
                                       </li>
                                    </ul>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="tp-footer-4-copyright text-center">
                        <span>Copyright © 2022 <a href="#">ThemePure</a></span>
