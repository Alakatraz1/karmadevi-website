...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:27:42 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
               ...
               <div class="cartmini__widget">
                  <div class="cartmini__widget-item">
                     ...
                     <div class="cartmini__content">
                        <h5 class="cartmini__title"><a href="shop-details.php">Nar Allt Ar Over</a></h5>
                        <div class="cartmini__price-wrapper">
                           <span class="cartmini__price">$108.00</span>
                              ...
                              <a href="login.php">
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M7.07223 7.468C7.03023 7.462 6.97623 7.462 6.92823 7.468C5.87223 7.432 5.03223 6.568 5.03223 5.506C5.03223 4.42 5.90823 3.538 7.00023 3.538C8.08623 3.538 8.96823 4.42 8.96823 5.506C8.96223 6.568 8.12823 7.432 7.07223 7.468Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M11.0441 11.428C9.97605 12.406 8.56005 13 7.00005 13C5.44005 13 4.02405 12.406 2.95605 11.428C3.01605 10.864 3.37605 10.312 4.01805 9.88C5.66205 8.788 8.35005 8.788 9.98205 9.88C10.6241 10.312 10.9841 10.864 11.0441 11.428Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                              ...
                              <form action="#">
                                 ...
                                 <span>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M7.22221 13.4444C10.6586 13.4444 13.4444 10.6586 13.4444 7.22221C13.4444 3.78578 10.6586 1 7.22221 1C3.78578 1 1 3.78578 1 7.22221C1 10.6586 3.78578 13.4444 7.22221 13.4444Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M15.0005 15L11.6172 11.6167" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                 </span>
                              </form>
                           </div>
                                       ...
                                       <div class="row tp-gx-20">
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index.php">University Classic</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-3.php">Online Course</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-4.php">Kids Education</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-5.php">Gym Coaching</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-6.php">High School</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="shop.php">Books Shop</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-7.php">Online Academy</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="red" href="index-8.php">Course Hub</a></h4>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                                   ...
                                                   <div class="col-xl-3 ">
                                                      <div class="tp-megamenu-fullwidth-list">
                                                         ...
                                                         <ul>
                                                            ...
                                                            <li><a href="university-about.php">University About</a></li>
                                                            <li><a href="university-campus.php">Campus</a></li>
                                                            <li><a href="university-mission.php">Mission & Values</a></li>
                                                            <li><a href="university-history.php">History</a></li>
                                                            <li><a href="university-leadership.php">Our Leadership</a></li>
                                                         </ul>
                                                      </div>
                                                   </div>
                                                   <div class="col-xl-6 ">
                                                            ...
                                                            <div class="row">
                                                               <div class="col-xl-6 col-12">
                                                                  <ul>
                                                                     ...
                                                                     <li><a href="become-instructor.php">Become a Instructor</a></li>
                                                                     <li><a href="up-coming.php">Maintenance</a></li>
                                                                  </ul>
                                                               </div>
                                                               <div class="col-xl-6 col-12">
                                                                  <ul>
                                                   ...
                                                   <div class="col-xl-3 ">
                                                      <div class="tp-megamenu-fullwidth-list">
                                                         ...
                                                         <ul>
                                                            ...
                                                            <li><a href="shop-details.php">Single Product</a></li>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-6">
                     <div class="tp-header-contact d-flex align-items-center justify-content-end">
                        ...
                        <div class="tp-header-4-btn d-none d-md-block ml-30">
                           <a href="university-schedule.php">Plan a Visit</a>
                        </div>
   ...
   <main>
      ...
      <!-- hero-area-start -->
      <section class="tp-hero-area tp-hero-4-bg" data-background="assets/img/hero/hero-4/hero-bg-1.jpg">
         <div class="container">
            <div class="row">
               <div class="col-lg-9">
                  <div class="tp-hero-4-wrapper">
                     <span class="tp-hero-subtitle wow fadeInUp" data-wow-delay=".3s">Welcome to Acadia School!</span>
                     <h2 class="tp-hero-4-title p-relative wow fadeInUp" data-wow-delay=".5s">School of endless possibilities.</h2>
                     <div class="tp-hero-4-info d-flex align-items-center flex-wrap wow fadeInUp" data-wow-delay=".7s">
                        <div class="tp-hero-4-btn">
                           <a class="tp-btn-circle" href="university-program.php">
                              <span>
                                 <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 13L13 1" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                       stroke-linejoin="round" />
                                    <path d="M1 1H13V13" stroke="white" stroke-width="1.5" stroke-linecap="round"
                                       stroke-linejoin="round" />
                                 </svg>
                              </span>
                              Enroll Now
      ...
      <!-- about-area-start -->
      <section class="about-area pt-115 pb-90 grey-bg">
         <div class="container">
            <div class="row">
               <div class="col-12">
                  <div class="tp-about-4-wrapper mb-75 wow fadeInUp" data-wow-delay=".3s">
                     <h2 class="tp-about-4-head">Our goal is to develop and meet the needs of each child so that he or
                        she becomes a well-rounded tomorrow individual.</h2>
                     <div class="tp-about-4-btn wow fadeInUp" data-wow-delay=".5s">
                        <a class="tp-btn-3" href="university-about.php">Why Choose Acadia</a>
                        <div class="tp-about-4-video">
                           <a class="popup-video" href="https://www.youtube.com/watch?v=_RpLvsA1SNM">
                              <span>
            ...
            <div class="row align-items-center">
               <div class="col-lg-3 col-sm-6">
                  <div class="tp-about-4-thumb-1 mb-30 wow fadeInUp" data-wow-delay=".5s">
                     <img src="assets/img/about/4/about-thumb-1.jpg" alt="">
                  </div>
               </div>
               <div class="col-lg-4 col-sm-6">
                  <div class="tp-about-4-thumb-2 mb-30 wow fadeInUp" data-wow-delay=".7s">
                     <img src="assets/img/about/4/about-thumb-2.jpg" alt="">
                  </div>
               </div>
               <div class="col-lg-3 col-sm-6">
                  <div class="tp-about-4-thumb-3 mb-30 wow fadeInUp" data-wow-delay=".9s">
                     <img src="assets/img/about/4/about-thumb-3.jpg" alt="">
                  </div>
               </div>
               <div class="col-lg-2 col-sm-6">
                  <div class="tp-about-4-thumb-4 mb-30 wow fadeInUp" data-wow-delay="1s">
                     <img src="assets/img/about/4/about-thumb-4.jpg" alt="">
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="tp-counter-4-bg wow fadeInUp" data-wow-delay=".3s">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-counter-4-item text-center">
                        <div class="tp-counter-4-icon">
                           <span><img src="assets/img/icon/counter/counter-4-icon-1.svg" alt=""></span>
                        </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-counter-4-item text-center">
                        <div class="tp-counter-4-icon">
                           <span><img src="assets/img/icon/counter/counter-4-icon-2.svg" alt=""></span>
                        </div>
                        <div class="tp-counter-4-content">
                           <h3 class="tp-counter-4-count mb-10">
                              <span data-purecounter-duration="1" data-purecounter-end="7" class="purecounter"></span>:2
                           </h3>
                           <div class="tp-counter-4-border"></div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-counter-4-item text-center">
                        <div class="tp-counter-4-icon">
                           <span><img src="assets/img/icon/counter/counter-4-icon-3.svg" alt=""></span>
                        </div>
                        <div class="tp-counter-4-content">
                           <h3 class="tp-counter-4-count mb-10">
                              <span data-purecounter-duration="1" data-purecounter-end="34"
                                 class="purecounter">34</span>
                           </h3>
                           <div class="tp-counter-4-border"></div>
                           <p>Athletic teams</p>
                        </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <div class="tp-counter-4-item text-center">
                        <div class="tp-counter-4-icon">
                           <span><img src="assets/img/icon/counter/counter-4-icon-4.svg" alt=""></span>
                        </div>
                        <div class="tp-counter-4-content">
                           <h3 class="tp-counter-4-count mb-10">
                              <span data-purecounter-duration="1" data-purecounter-end="41" class="purecounter"></span>%
                           </h3>
                           <div class="tp-counter-4-border"></div>
                           <p>Rate of growth since 2020</p>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="swiper-wrapper">
                  <div class="swiper-slide tp-program-4-item">
                     <div class="tp-program-4-thumb">
                        <img src="assets/img/program/4/program-thumb-1.jpg" alt="">
                     </div>
                     <div class="tp-program-4-content">
                        <h3 class="tp-program-4-title"><a href="university-course-details.php">Early Childhood</a></h3>
                        <span>British National Curriculum</span>
                        <div class="tp-program-4-btn">
                           <a href="university-course-details.php">
                              <span>
                                 <svg width="19" height="14" viewBox="0 0 19 14" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.8042 1L17.8042 7L11.8042 13" stroke="white" stroke-width="2"
                                       stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1 7H17.6359" stroke="white" stroke-width="2" stroke-miterlimit="10"
                  ...
                  <div class="swiper-slide tp-program-4-item">
                     <div class="tp-program-4-thumb">
                        <img src="assets/img/program/4/program-thumb-2.jpg" alt="">
                     </div>
                     <div class="tp-program-4-content">
                        <h3 class="tp-program-4-title"><a href="university-course-details.php">Elementary School</a></h3>
                  ...
                  <div class="swiper-slide tp-program-4-item">
                     <div class="tp-program-4-thumb">
                        <img src="assets/img/program/4/program-thumb-3.jpg" alt="">
                     </div>
                     <div class="tp-program-4-content">
                        <h3 class="tp-program-4-title"><a href="university-course-details.php">Middle School</a></h3>
                        <span>Cambridge Secondary</span>
                        <div class="tp-program-4-btn">
                           <a href="university-course-details.php">
                              <span>
                                 <svg width="19" height="14" viewBox="0 0 19 14" fill="none"
                  ...
                  <div class="swiper-slide tp-program-4-item">
                     <div class="tp-program-4-thumb">
                        <img src="assets/img/program/4/program-thumb-4.jpg" alt="">
                     </div>
                     <div class="tp-program-4-content">
                        <h3 class="tp-program-4-title"><a href="university-course-details.php">High School</a></h3>
                        <span>Cambridge AS & A Level</span>
                        <div class="tp-program-4-btn">
                           <a href="university-course-details.php">
                              <span>
                                 <svg width="19" height="14" viewBox="0 0 19 14" fill="none"
      ...
      <section class="course-area grey-bg pb-120">
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="tp-course-4-item d-flex wow fadeInUp" data-wow-delay=".3s">
                     <div class="tp-course-4-thumb">
                        <img src="assets/img/course/course-4-thumb-1.jpg" alt="">
                     </div>
                     <div class="tp-course-4-content">
                        ...
                        <h4 class="tp-course-4-title"><a href="course-details-2.php">English Langiage Club</a></h4>
                        ...
                        <div class="tp-course-4-avatar d-flex align-items-center justify-content-between">
                           <div class="tp-course-4-avatar-info d-flex align-items-center">
                              <div class="tp-course-4-avatar-thumb">
                                 <img src="assets/img/course/course-4-teacher-1.png" alt="">
                              </div>
               ...
               <div class="col-lg-6">
                  <div class="tp-course-4-item d-flex wow fadeInUp" data-wow-delay=".5s">
                     <div class="tp-course-4-thumb">
                        <img src="assets/img/course/course-4-thumb-2.jpg" alt="">
                     </div>
                     <div class="tp-course-4-content">
                        <div class="tp-course-4-rating">
                           <a href="#"><i class="fa-solid fa-star"></i></a>
                        ...
                        <h4 class="tp-course-4-title"><a href="course-details-2.php">Arabic Langiage Club</a></h4>
                        <div class="tp-course-4-info d-flex align-items-center">
                           <div class="tp-course-4-info-item">
                              <span>
                                 <span>
      ...
      <section class="school-area grey-bg fix pb-120">
         <div class="container">
            <div class="tp-school-4-bg wow fadeInUp" data-wow-delay=".3s" data-background="assets/img/bg/school-4-bg-1.jpg">
               <div class="tp-school-4-bg-2 grey-bg">
                  <div class="tp-school-4-shape">
                     <img src="assets/img/bg/school-4-bg-2.jpg" alt="">
                  </div>
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="tp-school-4-wrap">
                           ...
                           <div class="tp-school-4-btn">
                              <a href="university-about.php">Learn More
                                 <span>
                                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path d="M10.0034 1L15.0034 6L10.0034 11" stroke="#AB0C2F" stroke-width="1.5"
                                          stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                       <path d="M1 6H14.8633" stroke="#AB0C2F" stroke-width="1.5" stroke-miterlimit="10"
                                          stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                 </span>
                              </a>
                     ...
                     <div class="col-lg-6">
                        <div class="tp-school-4-thumb">
                           <img src="assets/img/bg/school-4-thumb-1.png" alt="">
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <section class="testimonial-area tp-testimonial-bg fix p-relative" data-background="assets/img/bg/testimonial-bg-2.jpg">
         ...
         <div class="container">
            <div class="row align-items-center">
               <div class="col-lg-6">
                  <div class="tp-video-wrap d-flex">
                     <div class="tp-video-icon text-center">
                        <a class="video-border-animation popup-video" href="https://www.youtube.com/watch?v=_RpLvsA1SNM">
                           <span>
               ...
               <div class="col-lg-6">
                  <div class="tp-testimonial-wrapper wow fadeInUp" data-wow-delay=".3s">
                     <div class="tp-testimonial-section mb-40">
            ...
            <div class="row align-items-end">
               ...
               <div class="col-lg-6">
                  <div class="tp-event-4-all-btn text-lg-end mb-70">
                     <a class="tp-btn-3" href="event.php">See More Events</a>
                  </div>
               </div>
            </div>
            <div class="row">
                  ...
                  <div class="tp-event-4-item mb-30 wow fadeInUp" data-wow-delay=".3s">
                     <div class="tp-event-4-thumb-wrap text-center">
                        <div class="tp-event-4-thumb fix">
                           <img src="assets/img/event/event-4-thumb-1.jpg" alt="">
                        </div>
                     </div>
                     <div class="tp-event-4-box">
                        <div class="tp-event-4-content">
                           <p>29 October, 2024</p>
                           <h4 class="tp-event-4-title"><a href="event-details.php">Painting Art Contest</a></h4>
                        ...
                        <div class="tp-event-4-info d-flex align-items-center justify-content-between">
                           <div class="tp-event-4-people">
                              <img src="assets/img/event/event-4-shape-1.png" alt="">
                           </div>
                           <div class="tp-event-4-btn">
                              <a href="event-details.php">Get Ticket</a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-event-4-item mb-30 wow fadeInUp" data-wow-delay=".5s">
                     <div class="tp-event-4-thumb-wrap text-center">
                        <div class="tp-event-4-thumb fix">
                           <img src="assets/img/event/event-4-thumb-2.jpg" alt="">
                        </div>
                     </div>
                     <div class="tp-event-4-box">
                        <div class="tp-event-4-content">
                           <p>29 October, 2024</p>
                           <h4 class="tp-event-4-title"><a href="event-details.php">Acadia Education Fair</a></h4>
                           <span><img src="assets/img/icon/location.svg" alt=""> United States</span>
                        </div>
                        <div class="tp-event-4-info d-flex align-items-center justify-content-between">
                           <div class="tp-event-4-people">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-event-4-item mb-30 wow fadeInUp" data-wow-delay=".7s">
                     <div class="tp-event-4-thumb-wrap text-center">
                        <div class="tp-event-4-thumb fix">
                           <img src="assets/img/event/event-4-thumb-3.jpg" alt="">
                        </div>
                     </div>
                     <div class="tp-event-4-box">
                        <div class="tp-event-4-content">
                           <p>29 October, 2024</p>
                           <h4 class="tp-event-4-title"><a href="event-details.php">Tech Summit 2024</a></h4>
                           <span><img src="assets/img/icon/location.svg" alt=""> United States</span>
                        </div>
                        <div class="tp-event-4-info d-flex align-items-center justify-content-between">
                           <div class="tp-event-4-people">
               ...
               <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                  <div class="tp-tutor-item text-center mb-30">
                     <div class="tp-tutor-icon">
                        <span><img src="assets/img/icon/tutor/tutor-icon-1.svg" alt=""></span>
                     </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-9">
                  <div class="tp-plan-4-wrapper">
                     <div class="row">
                        <div class="col-md-4">
                           <a href="university-campus.php" class="tp-plan-4-item active">
                              <div class="tp-plan-4-bg" data-background="assets/img/bg/plan/plan-4-bg-1.jpg"></div>
                              <div class="tp-plan-4-content d-flex align-items-center justify-content-center">
                                 <div class="tp-plan-4-box text-center">
                                    <span>01</span>
                                    <h4 class="tp-plan-4-title">Athletics</h4>
                                    <p>Athletics</p>
                                 </div>
                              </div>
                           </a>
                        ...
                        <div class="col-md-4">
                           <a href="university-leadership.php" class="tp-plan-4-item">
                              <div class="tp-plan-4-bg" data-background="assets/img/bg/plan/plan-4-bg-2.jpg"></div>
                              <div class="tp-plan-4-content d-flex align-items-center justify-content-center">
                                 <div class="tp-plan-4-box text-center">
                                    <span>02</span>
                                    <h4 class="tp-plan-4-title">Faculty and <br> staff</h4>
                                    <p>Meet our team</p>
                                 </div>
                              </div>
                           </a>
                        ...
                        <div class="col-md-4">
                           <a href="contact.php" class="tp-plan-4-item">
                              <div class="tp-plan-4-bg" data-background="assets/img/bg/plan/plan-4-bg-3.jpg"></div>
                              <div class="tp-plan-4-content d-flex align-items-center justify-content-center">
                                 <div class="tp-plan-4-box text-center">
                                    <span>03</span>
                                    <h4 class="tp-plan-4-title">Contact Us</h4>
                                    <p>Get in touch</p>
                                 </div>
                              </div>
                           </a>
                     ...
                     <div class="col-lg-2 col-sm-6">
                        <div class="tp-footer-widget tp-footer-4-col-1 mb-30">
                           <div class="tp-footer-4-btn">
                              <a class="active" href="university-apply.php">Apply Now</a>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:27:51 GMT -->
</html>