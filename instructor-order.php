...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:22 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-order.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             ...
                                             <div class="tpd-table-row">
                                                ...
                                                <div class="tpd-order-action">
                                                   <div class="tpd-action-btn">
                                                      <a href="assets/img/history.pdf" download="">
