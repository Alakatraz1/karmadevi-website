...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-my-bundle.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:29 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-my-course.php">
                                          <span>
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="dashboader-area mb-30">
                           <div class="tp-dashboard-tab">
                              ...
                              <div class="tp-dashboard-tab-list">
                                 <ul>
                                    <li>
                                       <a href="instructor-my-course.php">Publish <span>(86)</span></a>
                                    </li>
                                    <li>
                                       <a href="instructor-my-course-pending.php">Pending <span>(0)</span></a>
                                    </li>
                                    <li>
                                       <a class="active" href="instructor-my-bundle.php">Draft <span>(345)</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                        ...
                        <div class="course-area">
                           <div class="row">
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-1.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>June 11, 2021 at 6:01 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Customer-centric info Tech Strategies</a></h4>
                                       ...
                                       <div class="tp-dashboard-btn d-flex align-items-center justify-content-between">
                                          ...
                                          <div class="tp-course-action d-flex align-items-center">
                                             <div class="tpd-action-inexact-btn">
                                                <a href="instructor-course-edit.php">
                                                   ...
                                                   <button>
                                                      <span>
                                                         <svg xmlns="http://www.w3.org/2000/svg" width="12" height="10" viewBox="0 0 12 10" fill="none">
                                                            <path d="M8.09735 10L7.35335 9.18481L9.972 6.36096H2.93894C2.12447 6.36096 1.43106 6.05276 0.858706 5.43635C0.286235 4.82006 0 4.06814 0 3.18058C0 2.29288 0.286235 1.5409 0.858706 0.924616C1.43106 0.308205 2.12447 0 2.93894 0H3.27829V1.15385H2.93894C2.41765 1.15385 1.974 1.34962 1.608 1.74115C1.24188 2.13269 1.05882 2.6125 1.05882 3.18058C1.05882 3.74853 1.24188 4.22827 1.608 4.61981C1.974 5.01135 2.41765 5.20712 2.93894 5.20712H9.972L7.35335 2.36385L8.09735 1.56077L12 5.78404L8.09735 10Z" fill="white"/>
                                                          </svg>
                                                      </span>
                                                      Publish
                                                   </button>
                              ...
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-2.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>May 06, 2023 at 5:10 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Interior design concepts Masterclass</a></h4>
                                       <div class="tp-dashboard-course-meta">
                                          <span>
                                             <span>
                                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <div class="tp-dashboard-btn d-flex align-items-center justify-content-between">
                                          <div class="tp-dashboard-course-free pt-5 pb-5">
                                             <span>Free</span>
                                          </div>
                                          <div class="tp-course-action d-flex align-items-center">
                                             <div class="tpd-action-inexact-btn">
                              ...
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-3.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>July 14, 2021 at 7:05 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Academic listening and Note-taking</a></h4>
                                       <div class="tp-dashboard-course-meta">
                                          <span>
                                             <span>
                                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <div class="tp-dashboard-btn d-flex align-items-center justify-content-between">
                                          <div class="tp-course-pricing pt-5 pb-5">
                                             <span>$65.00</span>
                                          </div>
                                          <div class="tp-course-action d-flex align-items-center">
                                             <div class="tpd-action-inexact-btn">
                              ...
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-4.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>March 11, 2024 at 10:20 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Master jQuery in a Short Period of Time</a></h4>
                                       <div class="tp-dashboard-course-meta">
                                          <span>
                                             <span>
                                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-5.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>June 11, 2021 at 6:01 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">React Front To Back courses.</a></h4>
                                       <div class="tp-dashboard-course-meta">
                                          <span>
                                             <span>
                                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-xl-4 col-md-6">
                                 <div class="tp-dashboard-course tp-dashboard-course-2 mb-25">
                                    <div class="tp-dashboard-course-thumb">
                                       <a href="course-details-2.php"><img src="assets/img/dashboard/course/course-thumb-6.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-dashboard-course-content">
                                       <div class="tp-dashboard-rating">
                                          <span>October 21, 2020 at 4:10 am</span>
                                       </div>
                                       <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Introduction to Javascript for Beginners</a></h4>
                                       <div class="tp-dashboard-course-meta">
                                          <span>
                                             <span>
                                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
