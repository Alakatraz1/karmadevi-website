...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-campus.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:32 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
   ...
   <main>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-campus-counter-item counter-border text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="98"  class="purecounter">98</span>
                        </h3>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-campus-counter-item counter-border text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="72"  class="purecounter">72</span>%
                        </h3>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-campus-counter-item text-center">
                        <h3 class="tp-counter-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="35"  class="purecounter">35</span>
                        </h3>
               ...
               <div class="col-lg-12">
                  <div id="down" class="tp-campus-student-box pb-100 wow fadeInUp" data-wow-delay=".3s">
                     <div class="tp-campus-student-heading text-center">
                        ...
                        <p>Life at Acadia University is enriching, exciting, and energizing</p>
                     </div>
                     <div class="tp-campus-student-content">
                        <div class="tab-content" id="myTabContent">
                           <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              <div class="tp-campus-student-wrap p-relative">
                                 <div class="tp-campus-student-thumb">
                                    <img src="assets/img/campus/campus/campus-student-2.jpg" alt="">
                                 </div>
                                 <div class="tp-campus-student-item">
                                    <h4 class="tp-campus-student-item-title">Housing & Dining</h4>
                                    <p>Student Housing provides a home
                                       for eligible undergraduate and
                                       graduate students, including
                                       couples and families.</p>
                                    <div class="tp-campus-student-item-thumb">
                                       <img src="assets/img/campus/campus/campus-student.jpg" alt="">
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                              <div class="tp-campus-student-wrap p-relative">
                                 <div class="tp-campus-student-thumb">
                                    <img src="assets/img/campus/campus/campus-student-3.jpg" alt="">
                                 </div>
                                 <div class="tp-campus-student-item">
                           ...
                           <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                              <div class="tp-campus-student-wrap p-relative">
                                 <div class="tp-campus-student-thumb">
                                    <img src="assets/img/campus/campus/campus-student-4.jpg" alt="">
                                 </div>
                                 <div class="tp-campus-student-item">
                                    <h4 class="tp-campus-student-item-title">Arts & Culture</h4>
                                    <p>Student Housing provides a home
                                       for eligible undergraduate and
                                       graduate students, including
                                       couples and families.</p>
                           ...
                           <div class="tab-pane fade" id="Moscow" role="tabpanel" aria-labelledby="Moscow-tab">
                              <div class="tp-campus-student-wrap p-relative">
                                 <div class="tp-campus-student-thumb">
                                    <img src="assets/img/campus/campus/campus-student-5.jpg" alt="">
                                 </div>
                                 <div class="tp-campus-student-item">
                                    <h4 class="tp-campus-student-item-title">Moscow Campus</h4>
                                    <p>Student Housing provides a home
                                       for eligible undergraduate and
                                       graduate students, including
                                       couples and families.</p>
                     ...
                     <div class="tp-campus-student-list">
                        <ul class="nav nav-tabs " id="myTab" role="tablist">
                           <li class="nav-item" role="presentation">
                             <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Housing & Dining</button>
                           </li>
                           <li class="nav-item" role="presentation">
                             <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Student Clubs</button>
                           </li>
                           <li class="nav-item" role="presentation">
                             <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Arts & Culture</button>
                           </li>
                           <li class="nav-item" role="presentation">
                             <button class="nav-link" id="Moscow-tab" data-bs-toggle="tab" data-bs-target="#Moscow" type="button" role="tab" aria-controls="Moscow" aria-selected="false">Moscow Campus</button>
                           </li>
                         </ul>
                     </div>
                  </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-campus-activity-heading mb-70">
                     <h3 class="tp-campus-activity-title">Build lifelong friendships with students <br>
                        who share your interests, passions, and perspectives </h3>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="tp-campus-activity-content wow fadeInUp" data-wow-delay=".3s">  
                     <h4 class="tp-campus-activity-list-title"><span><img src="assets/img/campus/campus/ball.svg" alt=""></span> Athletics & Fitness</h4>
                     <div class="tp-campus-activity-list">
                        <ul>
                           <li><a href="#">Fitness <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                           ...
                           <li><a href="#">Athletics <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Pilates <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Boxing <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                        </ul>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-campus-activity-content wow fadeInUp" data-wow-delay=".5s">  
                     <h4 class="tp-campus-activity-list-title"><span><img src="assets/img/campus/campus/ball.svg" alt=""></span> Student Clubs</h4>
                     <div class="tp-campus-activity-list">
                        <ul>
                           <li><a href="#">Special Interest Club <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Health And Wellness Club <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Art Club <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Music Club <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                        </ul>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-campus-activity-content wow fadeInUp" data-wow-delay=".7s">  
                     <h4 class="tp-campus-activity-list-title"><span><img src="assets/img/campus/campus/ball.svg" alt=""></span> Student Activities</h4>
                     <div class="tp-campus-activity-list">
                        <ul>
                           <li><a href="#">Yoga Classes <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Basketball <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Football <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                              <path d="M1 9L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                              <path d="M1 1H9V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg></span></a></li>
                           <li><a href="#">Athletics <span><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
      ...
      <div class="tp-video-5-area tp-video-hover tp-video-inner-bg" data-background="assets/img/campus/campus/video-bg.jpg">
         <div class="container">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-campus.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:37 GMT -->
</html>