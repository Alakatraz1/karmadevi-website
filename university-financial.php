...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-financial.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:26 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
   ...
   <main>
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Financial Aid</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">Financial Aid</h3>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-campus-choose-wrapper text-center">
                     <div class="tp-campus-choose-btn admission">
                        <p>Financial Aid</p>
                        <a href="#"><span>
                        ...
                        <div class="tp-campus-choose-content mb-10">
                           <h2 class="tp-campus-choose-title admissions">At Stanford, we practice holistic admission. <br>
      ...
      <section class="tp-admission-counter-area grey-bg pb-120">
         <div class="container">
            <div class="tp-financial-counter-box">
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-admission-counter-item text-center">
                        <h3 class="tp-admission-counter-title">
                           <span data-purecounter-duration="4" data-purecounter-end="96" class="purecounter">96</span>%
                        </h3>
                        <p class="after">Of students receive <br>
                           scholarships or grants from <br>
                           the Acadia University</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-admission-counter-item text-center">
            ...
            <div class="row">
               ...
               <div class="col-lg-8">
                  <div class="tp-financial-mission-wrapper">
                     <h3 class="tp-financial-mission-title">The Financial Aid Process</h3>
                     <div class="tp-financial-process-box">
                        <h4 class="tp-financial-process-title"><span>1</span>Complete Application Form</h4>
                        <p>Creativity and innovation to challenge the status quo will affect what and how we
                           teach and the intellectual ambitions of the university itself.</p>
                     </div>   
                     <div class="tp-financial-process-box">
                        <h4 class="tp-financial-process-title"><span>2</span>Review</h4>
                        <p>Social engagement should orient students’ academic experiences to help them become
                           critically engaged citizens, dedicated to solving problems.</p>
                     </div>   
                     <div class="tp-financial-process-box">
                        <h4 class="tp-financial-process-title"><span>3</span>Make Your Deposit</h4>
                        <p>Estudiar’s commitment to student success, important scholarship and creative
                           activity, and public service sets it apart from other colleges.</p>
                     </div>   
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="tp-financial-item mb-30">
                     <div class="tp-financial-thumb">
                        <img src="assets/img/course/details/financial-thumb-1.jpg" alt="">
                     </div>
                     <div class="tp-financial-content">
                        <h4 class="tp-financial-content-title">Scholarships</h4>
                        <p>Acadia’s commitment to student success
                           important scholarship and creative activity,
                           apart from other colleges.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="tp-financial-item mb-30">
                     <div class="tp-financial-thumb">
                        <img src="assets/img/course/details/financial-thumb-2.jpg" alt="">
                     </div>
                     <div class="tp-financial-content">
                        <h4 class="tp-financial-content-title">Grants</h4>
                        <p>Your FAFSA will determine what grants you
                           qualify for—both from The Acadia University
                           & from federal and state government.</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="tp-financial-item mb-30">
                     <div class="tp-financial-thumb">
                        <img src="assets/img/course/details/financial-thumb-3.jpg" alt="">
                     </div>
                     <div class="tp-financial-content">
                        <h4 class="tp-financial-content-title">Loans</h4>
                        <p>Many students have used federal and private
                           loans to fund a quality education that would
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-financial.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:27 GMT -->
</html>