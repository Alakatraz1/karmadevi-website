...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-reviews-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
<head>
   <meta charset="utf-8">
                     ...
                     <div class="tpd-content-layout">
                        ...
                        <div class="tp-dashboard-tab mb-30">
                           ...
                           <div class="tp-dashboard-tab-list">
                              <ul>
                                 <li>
                                    <a href="instructor-reviews.php">Received  <span>(12)</span></a>
                                 </li>
                                 <li>
                                    <a class="active" href="instructor-reviews-2.php">Given <span>(08)</span></a>
                                 </li>
                              </ul>
                           </div>
                        </div>
                                 ...
                                 <div class="tpd-table-row">
                                    <div class="tpd-reviews-course">
                                       <div class="tpd-course-wrap">
                                          <h4 class="tpd-course-name">Course:</h4>
                                    ...
                                    <div class="tpd-reviews-feedback-2">
                                       ...
                                       <h4 class="tpd-reviews-comment">Awesome</h4>
                                    </div>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-reviews-course">
                                       <div class="tpd-course-wrap">
                                          <h4 class="tpd-course-name">Course:</h4>
                                          <span class="tpd-course-title">Create a Design System in Figma</span>
                                       </div>
                                    </div>
                                    <div class="tpd-reviews-feedback-2">
                                       <div class="tp-instructor-rating">
                                       ...
                                       <h4 class="tpd-reviews-comment">Nice Course</h4>
                                    </div>
                                    <div class="tpd-reviews-edit">
                                       <div class="tpd-reviews-edit-warp d-flex align-items-center justify-content-end">
                                          <div class="tpd-action-btn">
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-reviews-course">
                                       <div class="tpd-course-wrap">
                                          <h4 class="tpd-course-name">Course:</h4>
                                          <span class="tpd-course-title">Interior design concepts Masterclass</span>
                                       </div>
                                    </div>
                                    <div class="tpd-reviews-feedback-2">
                                       <div class="tp-instructor-rating">
                                       ...
                                       <h4 class="tpd-reviews-comment">Is Great Course!</h4>
                                    </div>
                                    <div class="tpd-reviews-edit">
                                       <div class="tpd-reviews-edit-warp d-flex align-items-center justify-content-end">
                                          <div class="tpd-action-btn">
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    ...
                                    <div class="tpd-reviews-feedback-2">
                                       ...
                                       <h4 class="tpd-reviews-comment">Happy</h4>
                                    </div>
                                    <div class="tpd-reviews-edit">
                                       <div class="tpd-reviews-edit-warp d-flex align-items-center justify-content-end">
                                          <div class="tpd-action-btn">
