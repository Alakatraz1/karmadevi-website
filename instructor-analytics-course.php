...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-analytics-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:36 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-9">
                     ...
                     <div class="tpd-course-area">
                        <div class="tp-dashboard-tab mb-45">
                           <h2 class="tp-dashboard-tab-title">Analytics</h2>
                           <div class="tp-dashboard-tab-list">
                              <ul>
                                 <li>
                                    <a href="instructor-analytics-overview.php">Overview</a>
                                 </li>
                                 <li>
                                    <a class="active" href="instructor-analytics-course.php">Courses</a>
                                 </li>
                                 <li>
                        ...
                        <div class="tpd-table li-hover-none mb-25">
                           <ul>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-assign-info analytic">
                                       <h4 class="tpd-assign-title">Product Design</h4>
                                       <div class="tpd-student-info">
                                          <p>Lesson:  <span>0</span></p>
                                          <p>Assignment:  <span>0</span></p>
                                          <p>Quiz  <span>1</span></p>
                                       </div>
                                    </div>
                                    <div class="tpd-assign-mark analytic">
                                       <span class="tpd-common-text">4</span>
                                    </div>
                                    <div class="tpd-assign-submit analytic">
                                       <h4 class="tpd-table-title">$0.00</h4>
                                    </div>
                                    <div class="tpd-assign-details analytic">
                                       ...
                                       <button><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8 1C4.136 1 1 4.136 1 8C1 11.864 4.136 15 8 15C11.864 15 15 11.864 15 8" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                          <path d="M8.69922 7.29969L14.4392 1.55969" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                          <path d="M15.006 4.381V1H11.625" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                          </svg>
                                       </button>
                                    </div>
                                 </div>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-assign-info analytic">
                                       <h4 class="tpd-assign-title">Graphic Design Masterclass</h4>
                                       <div class="tpd-student-info">
                                          <p>Lesson:  <span>0</span></p>
                                          <p>Assignment:  <span>0</span></p>
                                          <p>Quiz  <span>1</span></p>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-assign-info analytic">
                                       <h4 class="tpd-assign-title">Design System in Figma</h4>
                                       <div class="tpd-student-info">
                                          <p>Lesson:  <span>0</span></p>
                                          <p>Assignment:  <span>0</span></p>
                                          <p>Quiz  <span>1</span></p>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-assign-info analytic">
                                       <h4 class="tpd-assign-title">3D Motion Design</h4>
                                       <div class="tpd-student-info">
                                          <p>Lesson:  <span>0</span></p>
                                          <p>Assignment:  <span>0</span></p>
                                          <p>Quiz  <span>1</span></p>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    <div class="tpd-assign-info analytic">
                                       <h4 class="tpd-assign-title">App Development</h4>
                                       <div class="tpd-student-info">
                                          <p>Lesson:  <span>0</span></p>
                                          <p>Assignment:  <span>0</span></p>
                                          <p>Quiz  <span>1</span></p>
