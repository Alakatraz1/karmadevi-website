...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/student-enroll-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:26 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="student-enroll-course.php">
                                          <span>
                        ...
                        <div class="dashboader-area mb-30">
                           <div class="tp-dashboard-tab">
                              ...
                              <div class="tp-dashboard-tab-list">
                                 <ul>
                                    <li>
                                       <a class="active" href="student-enroll-course.php">Enrolled Courses <span>(56)</span></a>
                                    </li>
                                    <li>
                                       <a href="student-active-course.php">Active Courses <span>(21)</span></a>
                                    </li>
                                    <li>
                                       <a href="student-complete-course.php">Completed Courses <span>(38)</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
