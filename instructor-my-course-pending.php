...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-my-course-pending.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-9">
                     ...
                     <div class="tpd-content-layout">
                           ...
                           <div class="tp-dashboard-tab">
                              ...
                              <div class="tp-dashboard-tab-list">
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-my-course-pending.php">Pending <span>(0)</span></a>
                                    </li>
                                    <li>
                        ...
                        <!-- course-area-start -->
                        <div class="tpd-dashboard-pending-course pt-120">
                           <div class="row">
                              <div class="col-12">
