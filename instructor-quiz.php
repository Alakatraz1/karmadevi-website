...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-quiz.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:23 GMT -->
<head>
   <meta charset="utf-8">
                     ...
                     <div class="tpd-content-layout">
                        ...
                        <div class="section-area">
                           <div class="tp-dashboard-section">
                              <h2 class="tp-dashboard-title">Quiz Attempts</h2>
                           </div>
                           <div class="row">
                              <div class="col-lg-6">
                              ...
                              <ul>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info">
                                          ...
                                          <h4 class="tpd-quiz-title">What is design thinking's</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
                                       </div>
                                       <div class="tpd-quiz-ques">
                                       ...
                                       <div class="tpd-quiz-result">
                                          <div class="tpd-badge-item">
                                             <span class="tpd-badge danger">Fail</span>
                                          </div>
                                       </div>
                                       <div class="tpd-quiz-details">
                                          <div class="tpd-quiz-details-box d-flex">
                                          <div class="tpd-quiz-details-btn mr-15">
                                             <a class="tpd-border-btn" href="instructor-quiz-attempts.php">Details</a>
                                          </div>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info">
                                          <span class="tpd-common-date">March 26, 2024</span>
                                          <h4 class="tpd-quiz-title">Quiz Test 01</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
                                       </div>
                                       <div class="tpd-quiz-ques">
                                          <span class="tpd-common-text">1</span>
                                       </div>
                                       <div class="tpd-quiz-tm">
                                          <h4 class="tpd-table-title">0</h4>
                                       </div>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info">
                                          <span class="tpd-common-date">March 26, 2024</span>
                                          <h4 class="tpd-quiz-title">Quiz Test 02</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
                                       </div>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info">
                                          <span class="tpd-common-date">March 26, 2024</span>
                                          <h4 class="tpd-quiz-title">Knowledge Check</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
                                       </div>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info">
                                          <span class="tpd-common-date">March 26, 2024</span>
                                          <h4 class="tpd-quiz-title">Quiz Test 03</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
                                       </div>
