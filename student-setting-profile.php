...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/student-setting-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:27 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="student-setting-profile.php">
                                          <span>
                                             <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div class="col-12">
                              <div class="tp-dashboard-tab mb-25">
                                 ...
                                 <div class="tp-dashboard-tab-list">
                                    <ul>
                                       <li>
                                          <a class="active" href="student-setting-profile.php">Profile</a>
                                       </li>
                                       <li>
                                          <a href="student-setting-password.php">Password</a>
                                       </li>
                                       <li>
                                          <a href="student-setting-withdraw.php">Withdraw</a>
                                       </li>
                                       <li>
                                          <a href="student-setting-social.php">Social Profile</a>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/student-setting-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:28 GMT -->
</html>