...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-schedule.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:27 GMT -->
<head>
   <meta charset="utf-8">
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Schedule a Tour</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">Schedule a Tour</h3>
               </div>
            </div>
         </div>
      </div>
      </section>
      <!-- Tuition & Fees breadcrumb end -->
                           ...
                           <div class="tp-contact-input-form">
                              <div class="row">
                                 ...
                                 <div class="tp-schedule-btn">
                                    <button class="tp-btn">Submit <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
               ...
               <div class="col-xxl-10 col-lg-9">
                  <div class="tp-cta-wrapper d-flex align-items-center">
                     <div class="tp-cta-logo">
                        <a href="#"><img src="assets/img/cta/cta-logo-1.png" alt=""></a>
                     </div>
                     ...
                     <div class="col-lg-2 col-md-6">
                        <div class="tp-footer-widget tp-footer-4-col-1 mb-30">
                           <div class="tp-footer-4-btn tp-footer-btn-inner">
                              ...
                              <a href="university-schedule.php">Visit Us</a>
                           </div>
                        </div>
                     </div>
