...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-request-info.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:07 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="col-lg-12">
                  ...
                  <div class="tp-application-from-box wow fadeInUp" data-wow-delay=".5s">
                     <form id="contact-form" action="https://html.hixstudio.net/acadia-prev/acadia/assets/mail.php" method="POST">
                        ...
                        <div class="tp-contact-input-form request">
                           <h4 class="tp-application-from-title">Adress Information</h4>
                           <div class="row">
                              <div class="col-xl-6 col-lg-6">
                                 <div class="tp-contact-input schedule p-relative">
                                    <label>Country</label>
                           ...
                           <div class="row">
                              ...
                              <div class="col-xl-12">
                                 <div class="tp-contact-input-remeber schedule request">
                                    ...
                                    <label for="remeber">I authorize The Estuidar University to contact me via email about academic programs and services.</label>
                                 </div>
                              </div>
                              <div class="tp-schedule-btn">
                                 <button class="tp-btn">Submit Request <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
