...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-6.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:00 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <main>
            ...
            <div class="container custom-container-1300">
               <div class="tp-hero-6-wrap">
                     ...
                     <div class="col-xxl-7 col-xl-6 col-lg-7 col-md-12">
                        <div class="tp-hero-6-content">
                           <span class="tp-hero-6-subtitle wow fadeInUp" data-wow-delay=".3s"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" fill="none">
                            ...
                            </svg> World Class Education</span>
                           <h2 class="tp-hero-6-title wow fadeInUp" data-wow-delay=".5s">Get <span>2500+ <img class="wow bounceIn" data-wow-duration="1.5s" data-wow-delay=".4s" src="assets/img/hero/home-6/title-vector.png" alt=""></span> <br>Best Online Courses <br> From Acadia</h2>
                           <p class=" wow fadeInUp" data-wow-delay=".7s">Acquire global knowledge and build your professional skills</p>
                           <div class="tp-hero-6-btn-box d-flex align-items-center wow fadeInUp" data-wow-delay=".9s">
                              <div class="tp-hero-6-btn">
                                 <a class="tp-btn-inner" href="course-with-filter.php">Find Courses 
                                    <span>
                                 ...
                                 <a class="video-border-animation popup-video" href="https://www.youtube.com/watch?v=LlCwHnp3kL4">
                                    <span>
                                       <svg xmlns="http://www.w3.org/2000/svg" width="11" height="12" viewBox="0 0 11 12" fill="none">
                                          <path d="M0.0399028 0.755673C0.0421193 0.177043 0.67266 -0.187 1.17488 0.100395L10.2148 5.27351C10.717 5.56091 10.7142 6.2842 10.2098 6.57543L1.12999 11.8177C0.62556 12.1089 -0.00221065 11.7496 5.85292e-06 11.171L0.0399028 0.755673Z" fill="#031F42"/>
                                        </svg>
                                    </span>
                                 </a>
                              </div>
                     ...
                     <div class="col-xxl-5 col-xl-4 col-lg-5 col-md-6">
                        <div class="tp-hero-6-wrap p-relative wow fadeInUp" data-wow-delay=".5s">
                           ...
                           <div class="tp-hero-6-shape">
                              <div class="shape-1"><img src="assets/img/hero/home-6/hero-6-thumb-shape-1.png" alt=""></div>
                              <div class="shape-2"><img src="assets/img/hero/home-6/hero-6-thumb-shape-2.png" alt=""></div>
                              <div class="shape-3"><img src="assets/img/hero/home-6/hero-6-thumb-shape-3.png" alt=""></div>
                           </div>
                  ...
                  <div class="tp-hero-6-thumb">
                     <img src="assets/img/hero/home-6/hero-6-thumb.png" alt="">
                  </div>
               </div>
            </div>
            <div class="tp-hero-2-shape">
               <div class="tp-hero-2-shape-2">
                  <img src="assets/img/hero/hero-6-shape-2.png" alt="">
               </div>
         ...
         <!-- funfact-area-start -->
         <section class="tp-funfact-6-ptb">
            <div class="container custom-container-1300">
               <div class="row">
                     ...
                     <div class="tp-category-6-item mb-30 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tp-category-6-item-thumb">
                           <a href="course-categories.php">
                              <img src="assets/img/category/home-6/category-6-1.jpg" alt="">
                           </a>
                        </div>
                        <div class="tp-category-6-item-content text-center">
                           <h4 class="tp-category-6-item-title"><a href="course-categories.php">Mobile Application</a></h4>
                           <span>20 Courses</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="tp-category-6-item mb-30 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-category-6-item-thumb">
                           <a href="course-categories.php">
                              <img src="assets/img/category/home-6/category-6-2.jpg" alt="">
                           </a>
                        </div>
                        <div class="tp-category-6-item-content text-center">
                           <h4 class="tp-category-6-item-title"><a href="course-categories.php">Photography</a></h4>
                           <span>10 Courses</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="tp-category-6-item mb-30 wow fadeInUp" data-wow-delay=".7s">
                        <div class="tp-category-6-item-thumb">
                           <a href="course-categories.php">
                              <img src="assets/img/category/home-6/category-6-3.jpg" alt="">
                           </a>
                        </div>
                        <div class="tp-category-6-item-content text-center">
                           <h4 class="tp-category-6-item-title"><a href="course-categories.php">UI/UX Design</a></h4>
                           <span>8 Courses</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-3 col-lg-6 col-md-6">
                     <div class="tp-category-6-item mb-30 wow fadeInUp" data-wow-delay=".9s">
                        <div class="tp-category-6-item-thumb">
                           <a href="course-categories.php">
                              <img src="assets/img/category/home-6/category-6-4.jpg" alt="">
                           </a>
                        </div>
                        <div class="tp-category-6-item-content text-center">
                           <h4 class="tp-category-6-item-title"><a href="course-categories.php">Development</a></h4>
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-category-6-btn text-center pt-40">
                        <div class="tp-hero-6-btn">
                           <a class="tp-btn-inner" href="course-with-filter.php">View all Categories 
                              <span>
                                 <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="container custom-container-1300">
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="tp-category-6-heading tp-course-6-heading mb-60 wow fadeInUp" data-wow-delay=".4s">
                        ...
                        <h3 class="tp-section-3-title color-9">Most Popular 
                           <span>Courses 
                              <img class="tp-underline-shape-5 wow bounceIn" data-wow-duration="1.5s" data-wow-delay=".4s" src="assets/img/hero/home-6/title-vector.png" alt="">
                           </span>
                        </h3>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="tp-course-6-btn text-lg-end mb-60">
                        <div class="tp-hero-6-btn">
                           <a class="tp-btn-inner" href="course-with-filter.php">View all Courses 
                              <span>
                                 <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.71533 1L13 5.28471L8.71533 9.56941" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M1 5.28473H12.88" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="tp-course-grid-item d-flex mb-30">
                        <div class="tp-course-grid-thumb">
                           <a href="course-details-2.php"><img class="course-lightblue" src="assets/img/course/course-col/course-col-1.jpg" alt=""></a>
                        </div>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-course-grid-item d-flex mb-30">
                        <div class="tp-course-grid-thumb">
                           <a href="course-details-2.php"><img class="course-pink" src="assets/img/course/course-col/course-col-2.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-grid-content">
                           <div class="tp-course-filter-tag mb-10">
                           ...
                           <h4 class="tp-course-grid-title color-9">
                              <a href="course-details-2.php">Starting seo as your home
                                 based business</a>
                           </h4>
                           <div class="tp-course-teacher tp-course-grid-teacher">
                              <span><img src="assets/img/teacher/teacher-2.png" alt="">Benjamin Evalent</span>
                           </div>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-course-grid-item d-flex mb-30">
                        <div class="tp-course-grid-thumb">
                           <a href="course-details-2.php"><img class="course-pink" src="assets/img/course/course-col/course-col-3.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-grid-content">
                           <div class="tp-course-filter-tag mb-10">
                           ...
                           <h4 class="tp-course-grid-title color-9">
                              <a href="course-details-2.php">Grow personal financial security
                                 thinking </a>
                           </h4>
                           <div class="tp-course-teacher tp-course-grid-teacher">
                              <span><img src="assets/img/teacher/teacher-3.png" alt="">Benjamin Evalent</span>
                           </div>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-course-grid-item d-flex mb-30">
                        <div class="tp-course-grid-thumb">
                           <a href="course-details-2.php"><img class="course-sky" src="assets/img/course/course-col/course-col-5.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-grid-content">
                           <div class="tp-course-filter-tag mb-10">
                           ...
                           <h4 class="tp-course-grid-title color-9">
                              <a href="course-details-2.php">The complete guide to build
                                 restful API</a>
                           </h4>
                           <div class="tp-course-teacher tp-course-grid-teacher">
                              <span><img src="assets/img/teacher/teacher-4.png" alt="">Benjamin Evalent</span>
                           </div>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-md-8">
                     <div class="tp-team-6-wrapper">
                        <div class="swiper tp-team-6-active wow fadeInUp" data-wow-delay=".5s">
                           <div class="swiper-wrapper align-items-end">
                              <div class="swiper-slide">
                                 <div class="tp-event-details-item text-center mb-30">
                                    <div class="tp-event-details-item-thumb">
                                       <img src="assets/img/team/home-6/team-6-1.jpg" alt="">
                                    </div>
                                    <div class="tp-event-details-item-content">
                                       <h4 class="tp-event-details-item-title color-9"><a href="my-profile.php">Orabelle</a></h4>
                                       <p>Founder & CEO</p>
                              ...
                              <div class="swiper-slide">
                                 <div class="tp-event-details-item text-center mb-30">
                                    <div class="tp-event-details-item-thumb">
                                       <img src="assets/img/team/home-6/team-6-2.jpg" alt="">
                                    </div>
                                    <div class="tp-event-details-item-content">
                                       <h4 class="tp-event-details-item-title color-9"><a href="my-profile.php">Hollace</a></h4>
                                       <p>Math Teacher</p>
                                       <div class="tp-event-details-item-social">
                                          <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                          <a href="#"><i class="fa-brands fa-twitter"></i></a>
                              ...
                              <div class="swiper-slide">
                                 <div class="tp-event-details-item text-center mb-30">
                                    <div class="tp-event-details-item-thumb">
                                       <img src="assets/img/team/home-6/team-6-3.jpg" alt="">
                                    </div>
                                    <div class="tp-event-details-item-content">
                                       <h4 class="tp-event-details-item-title color-9"><a href="my-profile.php">Alejandro</a></h4>
                                       <p>Math Teacher</p>
                                       <div class="tp-event-details-item-social">
                                          <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                          <a href="#"><i class="fa-brands fa-twitter"></i></a>
               ...
               <div class="row">
                  <div class="col-lg-6">
                     <div class="tp-banner-sm-2-wrap mb-60 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="tp-banner-sm-2-btn">
                           <a href="contact.php">View Programs</a>
                        </div>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-banner-sm-2-wrap tp-banner-sm-2-bg-2 mb-60 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="tp-banner-sm-2-btn">
                           <a href="course-with-filter.php">View Programs</a>
                        </div>
                        <div class="tp-banner-sm-2-shape-1">
                     ...
                     <div class="tp-brand-6-heading">
                        <div class="tp-team-6-heading mb-45">
                           ...
                           <h3 class="tp-section-3-title color-9">Who will <br>
                              You Learn 
                              <span>With?
                                 <svg class="tp-underline-shape-9 wow bounceIn" data-wow-duration="1.5s" data-wow-delay=".4s" xmlns="http://www.w3.org/2000/svg" width="111" height="15" viewBox="0 0 111 15" fill="none">
                                    <path d="M62.1108 2.68868C60.1173 2.9024 52.377 3.4609 44.9511 3.93637C25.5454 5.15442 17.3727 5.90815 10.7724 6.96722C5.62809 7.79532 0.761965 8.90192 0.507694 9.30708C0.461463 9.38074 0.444131 10.282 0.454941 11.2903C0.46274 12.9112 0.545908 13.1965 1.1022 13.7535C1.45597 14.1014 1.93161 14.445 2.13035 14.5462C2.47785 14.7142 15.6498 13.1734 18.7775 12.5959C20.1604 12.3674 62.9058 10.0822 73.3358 9.68193C77.0891 9.55086 85.8219 9.46206 92.7292 9.50905C99.6366 9.55605 105.882 9.51808 106.588 9.45741C108.34 9.32417 109.856 8.01034 109.881 6.64049C109.877 5.81206 109.798 5.67069 109.237 5.65428C108.626 5.63958 108.625 5.60359 109.372 5.32534C110.407 4.92893 110.521 4.70878 109.894 4.22631C109.293 3.77898 109.174 3.17069 109.711 3.15197C109.905 3.14516 110.07 2.9593 110.064 2.77939C110.056 2.5635 109.929 2.42383 109.758 2.42978C109.612 2.43489 108.966 2.0972 108.342 1.6867L107.193 0.934254L86.4753 1.6217C75.0923 1.98318 64.1286 2.47412 62.1108 2.68868ZM78.9778 3.5407C79.1291 3.67952 80.5964 3.77238 82.2781 3.71365C83.961 3.69091 87.1344 3.72419 89.3586 3.82665C92.9026 3.9911 92.5139 4.0407 86.1965 4.1172C82.2457 4.18312 75.7845 4.33669 71.8363 4.47457C67.888 4.61245 64.7171 4.65112 64.7633 4.57746C64.8327 4.46696 67.5342 4.26454 70.7744 4.11537C74.0134 3.93021 76.7868 3.68926 76.9511 3.50339C77.3054 3.16679 78.5984 3.15766 78.9778 3.5407ZM104.15 3.23808C103.665 3.32706 102.885 3.3543 102.444 3.29765C102.027 3.24016 102.439 3.15372 103.365 3.12138C104.315 3.08819 104.659 3.14824 104.15 3.23808ZM50.5888 5.36065C50.5426 5.43431 44.9164 5.73886 38.0704 6.04998C31.2499 6.39623 27.3492 6.49642 29.417 6.31614C33.7708 5.91192 50.7275 5.13965 50.5888 5.36065ZM62.7286 5.00877C62.6593 5.11927 62.4412 5.16291 62.2668 5.06092C62.0681 4.95978 62.1374 4.84929 62.4055 4.83992C62.6724 4.79458 62.8224 4.89742 62.7286 5.00877ZM105.9 5.84284C106.08 6.08876 105.375 6.1854 103.717 6.20729C102.374 6.18214 97.5968 6.34896 93.1136 6.54154C88.6304 6.73412 84.3397 6.84793 83.606 6.8015C81.4281 6.62538 69.7038 6.99877 60.9362 7.48507C51.926 8.01587 51.3592 7.85553 59.5806 7.1001C66.9503 6.41044 105.567 5.38615 105.9 5.84284ZM47.0541 8.25805C39.7038 8.80293 32.1241 9.06762 33.8919 8.68166C34.6181 8.5122 39.1719 8.2451 43.9976 8.07658C52.6022 7.81213 52.6753 7.80957 47.0541 8.25805ZM79.2366 7.45844C79.2429 7.63835 79.0748 7.71627 78.8761 7.61513C78.6761 7.47801 78.5004 7.34005 78.4979 7.26808C78.4954 7.19612 78.6635 7.1182 78.8585 7.11139C79.0534 7.10458 79.2291 7.24255 79.2366 7.45844ZM79.9678 7.43291C79.9741 7.61282 79.8585 7.79698 79.7122 7.80209C79.5904 7.80634 79.5354 7.62813 79.6022 7.44567C79.6678 7.22723 79.7846 7.07905 79.8577 7.0765C79.9065 7.07479 79.9602 7.21702 79.9678 7.43291ZM81.7957 7.36908C81.8751 7.54643 81.7839 7.72974 81.5889 7.73655C81.3695 7.74421 81.1927 7.57026 81.1864 7.39035C81.1788 7.17446 81.2713 7.02713 81.3932 7.02288C81.5394 7.01777 81.715 7.15574 81.7957 7.36908ZM104.962 6.92035C105.41 7.19289 105.412 7.22887 104.85 7.21246C104.509 7.22438 103.919 7.10088 103.499 6.97142L102.758 6.7091L103.611 6.67931C104.074 6.66314 104.687 6.74981 104.962 6.92035ZM48.5979 9.1408C44.9446 9.34043 39.0221 9.54724 35.4369 9.60039C31.853 9.68952 34.8495 9.54885 42.088 9.29608C49.3265 9.04331 52.2524 8.97716 48.5979 9.1408ZM2.77105 11.93C2.77733 12.1099 2.41803 12.3025 2.00245 12.281C1.32003 12.3049 1.26877 12.2346 1.6743 11.9683C2.34164 11.5126 2.75597 11.4982 2.77105 11.93ZM6.63867 11.5787C6.59244 11.6524 5.72007 11.827 4.72459 11.9698C3.53538 12.1554 3.02231 12.1373 3.25849 11.9129C3.58839 11.5772 6.87109 11.2464 6.63867 11.5787ZM101.938 9.0794C101.575 9.16413 100.917 9.18711 100.476 9.13046C100.035 9.07382 100.325 8.99164 101.129 8.96356C101.933 8.93547 102.301 8.99467 101.938 9.0794Z" fill="#FFD25D"/>
                                  </svg>
                              </span>
                           </h3>
                        </div>
            ...
            <div class="container custom-container-1300">
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="tp-course-6-btn text-lg-end mb-60">
                        <div class="tp-hero-6-btn">
                           <a class="tp-btn-inner" href="blog-stories.php">See All Articles 
                              <span>
                                 <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.71533 1L13 5.28471L8.71533 9.56941" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M1 5.28473H12.88" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
               ...
               <div class="row">
                     ...
                     <div class="tp-blog-6-item">
                        <div class="tp-blog-stories-item p-relative mb-50">
                           <div class="tp-blog-stories-thumb">
                              <a href="blog-details.php"><img src="assets/img/blog/blog-stories/blog-stories-thumb-1.jpg" alt=""></a>
                           </div>
                           <div class="tp-blog-stories-content">
                              ...
                              <h4 class="tp-blog-stories-title"><a href="blog-details.php">A better alternative to grading
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-blog-6-item">
                        <div class="tp-blog-stories-item p-relative mb-50">
                           <div class="tp-blog-stories-thumb">
                              <a href="blog-details.php"><img src="assets/img/blog/blog-stories/blog-stories-thumb-2.jpg" alt=""></a>
                           </div>
                           <div class="tp-blog-stories-content">
                              <div class="tp-blog-stories-tag-wrap d-flex">
                              ...
                              <h4 class="tp-blog-stories-title"><a href="blog-details.php">The future of online learning trends and innovations</a></h4>
                              <div class="tp-blog-stories-user-box d-flex align-items-center">
                                 <div class="tp-blog-stories-user-thumb">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-blog-6-item">
                        <div class="tp-blog-stories-item p-relative mb-50">
                           <div class="tp-blog-stories-thumb">
                              <a href="blog-details.php"><img src="assets/img/blog/blog-stories/blog-stories-thumb-3.jpg" alt=""></a>
                           </div>
                           <div class="tp-blog-stories-content">
                              <div class="tp-blog-stories-tag-wrap d-flex">
                              ...
                              <h4 class="tp-blog-stories-title"><a href="blog-details.php">Navigating higher education tips for success</a></h4>
                              <div class="tp-blog-stories-user-box d-flex align-items-center">
                                 <div class="tp-blog-stories-user-thumb">
         ...
         <!-- cta-area-start -->
         <section class="tp-cta-6-area pt-120 pb-120" data-bg-color="#5956E9">
            <div class="container">
               <div class="row justify-content-center">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-6.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:10 GMT -->
</html>