...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-requirements.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:03 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
   ...
   <main>
      ...
      <!-- Course Requirements breadcrumb start -->
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Academics</span>
                     <span class="white">Degree Requirements</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">Degree Requirements</h3>
               </div>
            </div>
         </div>
      </div>
      </section>
      <!-- Course Requirements breadcrumb end -->
               ...
               <div class="col-lg-9">
                  <div class="tp-course-requrement-wrapper">
                     <div class="tp-course-requrement-heading">
                        ...
                        <p>The B.Sc. Program in Computer Science & Engineering (CSE) is designed to produce skilled graduates in the field to satisfy the growing demands of computer engineering graduates in the home and abroad. It provides the students an opportunity to obtain the broad knowledge of Computer Science, Computer Engineering with the freedom to tailor the program according to the student's individual needs. Students are responsible for reading course descriptions when choosing classes for their self-designed major. If they choose a class that requires permissionbecause of prerequisites and/or is a course at another college within Acadia University</p>
                        ...
                        <div class="tp-course-requrement-bulet">
                           ...
                           <div class="tp-course-requrement-bulet-content">
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                               ...
                               </svg></span> CSE-112 – Software Engineering (Theory)</p>
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                                 <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                                 <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                               </svg></span> CSE-113 – Programming and Problem Solving (Theory & lab)</p>
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                                 <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                                 <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                               </svg></span> CSE-114 – Data Communication (Theory)</p>
                           </div>
                        </div>
                        <div class="tp-course-requrement-bulet">
                           <h5 class="tp-course-requrement-bulet-title">Microeconomic Foundations (4 units)</h5>
                        ...
                        <div class="tp-course-requrement-bulet">
                           <div class="tp-course-requrement-bulet-content">
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                               ...
                               </svg></span> 2023 - 24 Computer Science Worksheet</p>
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                 <path opacity="0.4" d="M15.3 6.9615H12.8435C10.829 6.9615 9.1885 5.321 9.1885 3.3065V0.85C9.1885 0.3825 8.806 0 8.3385 0H4.7345C2.1165 0 0 1.7 0 4.7345V12.2655C0 15.3 2.1165 17 4.7345 17H11.4155C14.0335 17 16.15 15.3 16.15 12.2655V7.8115C16.15 7.344 15.7675 6.9615 15.3 6.9615Z" fill="#292D32"/>
                                 <path d="M11.3055 0.178445C10.957 -0.170055 10.3535 0.0679453 10.3535 0.552445V3.51894C10.3535 4.75994 11.4075 5.78845 12.691 5.78845C13.4985 5.79695 14.6205 5.79695 15.581 5.79695C16.0655 5.79695 16.3205 5.22745 15.9805 4.88745C14.7565 3.65495 12.5635 1.43645 11.3055 0.178445Z" fill="#292D32"/>
                                 <path d="M9.3498 9.98765H4.2498C3.9013 9.98765 3.6123 9.69865 3.6123 9.35015C3.6123 9.00165 3.9013 8.71265 4.2498 8.71265H9.3498C9.6983 8.71265 9.9873 9.00165 9.9873 9.35015C9.9873 9.69865 9.6983 9.98765 9.3498 9.98765Z" fill="#292D32"/>
                                 <path d="M7.6498 13.3875H4.2498C3.9013 13.3875 3.6123 13.0985 3.6123 12.75C3.6123 12.4015 3.9013 12.1125 4.2498 12.1125H7.6498C7.9983 12.1125 8.2873 12.4015 8.2873 12.75C8.2873 13.0985 7.9983 13.3875 7.6498 13.3875Z" fill="#292D32"/>
                               </svg></span> 2022 - 23 Computer Science Worksheet</p>
                              <p><span><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                                 <path opacity="0.4" d="M15.3 6.9615H12.8435C10.829 6.9615 9.1885 5.321 9.1885 3.3065V0.85C9.1885 0.3825 8.806 0 8.3385 0H4.7345C2.1165 0 0 1.7 0 4.7345V12.2655C0 15.3 2.1165 17 4.7345 17H11.4155C14.0335 17 16.15 15.3 16.15 12.2655V7.8115C16.15 7.344 15.7675 6.9615 15.3 6.9615Z" fill="#292D32"/>
                                 <path d="M11.3055 0.178445C10.957 -0.170055 10.3535 0.0679453 10.3535 0.552445V3.51894C10.3535 4.75994 11.4075 5.78845 12.691 5.78845C13.4985 5.79695 14.6205 5.79695 15.581 5.79695C16.0655 5.79695 16.3205 5.22745 15.9805 4.88745C14.7565 3.65495 12.5635 1.43645 11.3055 0.178445Z" fill="#292D32"/>
                                 <path d="M9.3498 9.98765H4.2498C3.9013 9.98765 3.6123 9.69865 3.6123 9.35015C3.6123 9.00165 3.9013 8.71265 4.2498 8.71265H9.3498C9.6983 8.71265 9.9873 9.00165 9.9873 9.35015C9.9873 9.69865 9.6983 9.98765 9.3498 9.98765Z" fill="#292D32"/>
                                 <path d="M7.6498 13.3875H4.2498C3.9013 13.3875 3.6123 13.0985 3.6123 12.75C3.6123 12.4015 3.9013 12.1125 4.2498 12.1125H7.6498C7.9983 12.1125 8.2873 12.4015 8.2873 12.75C8.2873 13.0985 7.9983 13.3875 7.6498 13.3875Z" fill="#292D32"/>
                               </svg></span> Program worksheet</p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="tp-course-requrement-widget-box">
                     <div class="tp-course-requrement-widget mb-30">
                        <div class="tp-course-requrement-widget-content">
                           <a href="university-requirements.php">Degree Requirements</a>
                           <a href="university-apply.php">How to Apply</a>
                           <a href="university-leadership.php">Faculty & Staff</a>
                           <a href="university-financial.php">Financial Add</a>
                        </div>
                     </div>
                     <div class="tp-course-requrement-widget-btn mb-30">
                        <a class="tp-btn btn-1 w-100 text-center" href="university-request-info.php">Request information</a>
                        <a class="tp-btn btn-2 w-100 text-center" href="university-apply.php">Apply Now</a>
                     </div>
                     ...
                     <div class="tp-course-requrement-widget-faq">
                        <h4 class="tp-course-requrement-widget-faq-title">Do you have <br>
                           more questions?</h4>
                        <p>Read our <a href="faq.php">FAQ</a></p>
