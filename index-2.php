                        ...
                        <nav class="tp-main-menu-content">
                           <ul>
                              ...
                              <li class="has-dropdown">
                                 ...
                                 <ul class="tp-submenu">
                                    <li><a href="blog-stories.php">Blog</a></li>
                                    <li><a href="blog-stories-sidebar.php">Blog Grid</a></li>
                              ...
                              <div class="col-xxl-9 col-lg-11">
                                 <div class="tp-hero-wrapper">
                                    ...
                                    <div class="tp-hero-btn">
                                       <a class="tp-btn" href="university-program.php">
                                          Enroll Now 
                                          <span>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tp-service-wrap">
                           ...
                           <h4 class="tp-service-title"><a href="university-about.php">Why study at <br> Acadia?</a></h4>
                           <div class="tp-service-btn">
                              <a href="university-about.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-service-wrap">
                           ...
                           <h4 class="tp-service-title"><a href="university-requirements.php">Certification <br> Guarantee</a></h4>
                           <div class="tp-service-btn">
                              <a href="university-requirements.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 6H11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M6 1L11 6L6 11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg></span>
                              </a>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".7s">
                        <div class="tp-service-wrap">
                           ...
                           <h4 class="tp-service-title"><a href="university-admission-overview.php">Graduate <br> Admissions</a></h4>
                           <div class="tp-service-btn">
                              <a href="university-admission-overview.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 6H11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M6 1L11 6L6 11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg></span>
                              </a>
                  ...
                  <div class="col-lg-3 col-md-6">
                     <div class="tp-service-item text-center mb-40 wow fadeInUp" data-wow-delay=".9s">
                        <div class="tp-service-wrap">
                           ...
                           <h4 class="tp-service-title"><a href="university-tuition-fees.php">Scholarships <br> & fees</a></h4>
                           <div class="tp-service-btn">
                              <a href="university-tuition-fees.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M1 6H11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 <path d="M6 1L11 6L6 11" stroke="#161613" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg></span>
                              </a>
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-service-all text-center">
                        <span>Trusted by the worlds <a href="university-about.php">Best University <svg width="10" height="10" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div class="tp-about-wrapper mb-60 wow fadeInRight" data-wow-delay=".3s">
                        ...
                        <div class="tp-about-list">
                           ...
                           <div class="tp-about-btn pt-10">
                              <a class="tp-btn tp-btn-sm" href="university-apply.php">Book an Appointment 
                                 <span>
               ...
               <div class="row">
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide tp-program-item grey-bg mb-50">
                              <div class="tp-program-thumb fix">
                                 <a href="university-application-form.php"><img src="assets/img/program/program-thumb-1.jpg" alt="program-thumb"></a>
                              </div>
                              <div class="tp-program-content">
                                 <h3 class="tp-program-title"><a href="university-application-form.php">Major in Economics</a></h3>
                           ...
                           <div class="swiper-slide tp-program-item grey-bg mb-50">
                              <div class="tp-program-thumb fix">
                                 <a href="university-application-form.php"><img src="assets/img/program/program-thumb-2.jpg" alt="program-thumb"></a>
                              </div>
                              <div class="tp-program-content">
                                 <h3 class="tp-program-title"><a href="university-application-form.php">Business Media</a></h3>
                                 <p>The Economics Major can be combined <br> with a Major in another subject in order Double Major Degree.</p>
                                 <div class="tp-program-tag">
                           ...
                           <div class="swiper-slide tp-program-item grey-bg mb-50">
                              <div class="tp-program-thumb fix">
                                 <a href="university-application-form.php"><img src="assets/img/program/program-thumb-3.jpg" alt="program-thumb"></a>
                              </div>
                              <div class="tp-program-content">
                                 <h3 class="tp-program-title"><a href="university-application-form.php">Major in Economics</a></h3>
                                 <p>The Economics Major can be combined <br> with a Major in another subject in order Double Major Degree.</p>
                  ...
                  <div class="col-12">
                     <div class="tp-program-all text-center">
                        <p>Explore the most appropriate promgram.​​ <a href="university-program.php">View all Programs <span>
               ...
               <div class="tp-event-wrap wow fadeInUp" data-wow-delay=".3s">
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                           <div class="tp-event-content">
                              <h3 class="tp-event-title"><a class="tp-img-reveal tp-img-reveal-item" href="event-details.php" data-img="assets/img/event/event-thumb-1.jpg" data-fx="1">Street Performance: Call for Artist</a></h3>
                  ...
                  <div class="tp-event-item">
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                           <div class="tp-event-content">
                              <h3 class="tp-event-title"><a class="tp-img-reveal tp-img-reveal-item" href="event-details.php" data-img="assets/img/event/event-thumb-2.jpg" data-fx="1">The Middle East in the Twentieth Century</a></h3>
                              <div class="tp-event-info">
                                 <span><i class="fa-sharp fa-light fa-clock"></i>8:00AM - 10:00AM</span>
                                 <span><i class="fa-sharp fa-light fa-location-dot"></i>United States</span>
                              </div>
                  ...
                  <div class="tp-event-item">
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                           <div class="tp-event-content">
                              <h3 class="tp-event-title"><a class="tp-img-reveal tp-img-reveal-item" href="event-details.php" data-img="assets/img/event/event-thumb-3.jpg" data-fx="1">Global Education Fall Meeting for Everyone</a></h3>
                              <div class="tp-event-info">
                                 <span><i class="fa-sharp fa-light fa-clock"></i>8:00AM - 10:00AM</span>
                                 <span><i class="fa-sharp fa-light fa-location-dot"></i>United States</span>
                              </div>
                  ...
                  <div class="tp-event-item">
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-9">
                           <div class="tp-event-content">
                              <h3 class="tp-event-title"><a class="tp-img-reveal tp-img-reveal-item" href="event-details.php" data-img="assets/img/event/event-thumb-4.jpg" data-fx="1">Painting Art Contest 2020</a></h3>
                              <div class="tp-event-info">
                                 <span><i class="fa-sharp fa-light fa-clock"></i>8:00AM - 10:00AM</span>
                                 <span><i class="fa-sharp fa-light fa-location-dot"></i>United States</span>
                              </div>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-blog-item text-center mb-40 wow fadeInLeft" data-wow-delay=".2s">
                        <div class="tp-blog-thumb fix">
                           <a href="blog-details.php"><img src="assets/img/blog/blog-thumb-1.jpg" alt="blog-thumb"></a>
                        </div>
                        <div class="tp-blog-content">
                           <span class="tp-blog-tag">Video & Tips</span>
                           <h4 class="tp-blog-title">
                              <a href="blog-details.php">The Importance Of Intrinsic Motivation for Students</a>
                           </h4>
                  ...
                  <div class="col-lg-6">
                     <div class="tp-blog-item text-center mb-40 wow fadeInRight" data-wow-delay=".2s">
                        ...
                        <div class="tp-blog-content">
                           <span class="tp-blog-tag">Video & Tips</span>
                           <h4 class="tp-blog-title">
                              <a href="blog-details.php">Those Other College Expenses You Aren`t Thinking About</a>
                           </h4>
                           <div class="tp-blog-meta">
                              <span>
                                 <span>
                  ...
                  <div class="col-xxl-10 col-lg-9">
                     <div class="tp-cta-wrapper d-flex align-items-center">
                        <div class="tp-cta-logo">
                           <a href="index.php"><img src="assets/img/cta/cta-logo-1.png" alt=""></a>
                        </div>
                  ...
                  <div class="col-xxl-2 col-lg-3">
                     <div class="tp-cta-btn-wrap">
                        <div class="tp-cta-btn text-lg-end">
                           <a class="tp-btn" href="university-apply.php">Apply Now <span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
