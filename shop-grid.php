...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/shop-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:48 GMT -->
<head>
      <meta charset="utf-8">
                                       ...
                                       <div class="row tp-gx-20">
                                          ...
                                          <div class="col-xxl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="blue" href="index-7.php">Online Academy</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xxl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="blue" href="index-8.php">Course Hub</a></h4>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                           <div class="row">
                              ...
                              <div class="col-lg-4 col-sm-6">
                                 <div class="tp-shop-product-item text-center mb-50">
                                    <div class="tp-shop-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/product/shop-product-11.jpg" alt=""></a>
                                       <div class="tp-shop-product-thumb-tag">
                                          <span class="hot">Hot</span>
                                       </div>
                                       <div class="tp-shop-product-thumb-btn">
                              ...
                              <div class="col-lg-12">
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    <div class="tp-shop-list-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/list/shop-list-1.jpg" alt=""></a>
                                    </div>
                                 ...
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    <div class="tp-shop-list-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/list/shop-list-2.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-shop-list-product-content p-relative">
                                       <div class="tp-shop-product-thumb-tag">
                                          <span class="off">35% off</span>
                                 ...
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    <div class="tp-shop-list-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/list/shop-list-3.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-shop-list-product-content p-relative">
                                       <div class="tp-shop-product-thumb-tag">
                                          <span class="new">New</span>
                                 ...
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    <div class="tp-shop-list-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/list/shop-list-4.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-shop-list-product-content p-relative">
                                       <div class="tp-shop-product-thumb-tag">
                                          <span class="hot">Hot</span>
                                 ...
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    <div class="tp-shop-list-product-thumb p-relative">
                                       <a href="shop-details.php"><img src="assets/img/shop/list/shop-list-5.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-shop-list-product-content p-relative">
                                       <div class="tp-shop-product-thumb-tag">
                                          <span class="new">New</span>
                                 ...
                                 <div class="tp-shop-list-product-item d-flex mb-10">
                                    ...
                                    <div class="tp-shop-list-product-content p-relative">
                                       ...
                                       <h4 class="tp-shop-product-title"><a href="shop-details.php">Emelie Schepp Vita</a></h4>
                                       <p>Online Only! Get more for less with The Work’s expertly hand-picked Book
                                          Bundles. These are a collection of great quality products,</p>
                                       <div class="tp-shop-product-price">
                                          <span>$105.00</span>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/shop-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:51 GMT -->
</html>
