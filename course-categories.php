...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-categories.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:07 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <main>
         ...
         <!-- course banner start -->
         <section class="tp-course-banner-area tp-course-banner-bg p-relative pt-180 pb-100
         " data-background="assets/img/course/course-categories/course-categories-bg.png"> 
            <div class="tp-course-banner-shape">
               <div class="shape-1">
                  <img src="assets/img/course/course-categories/shape-1.png" alt="">
               </div>
               <div class="shape-2">
                  <img src="assets/img/course/course-categories/shape-2.png" alt="">
               </div>
            </div>
            <div class="container">
               <div class="row">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <h3 class="tp-course-categories-title">Development</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-course-categories-icon">
                           <span class="color-1">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1998 4.80017H4.7998V11.2002H11.1998V4.80017Z" fill="#23344D" />
                        ...
                        <h3 class="tp-course-categories-title">UI/UX Design</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".7s">
                        <div class="tp-course-categories-icon">
                           <span class="color-2">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1998 4.80017H4.7998V11.2002H11.1998V4.80017Z" fill="#23344D" />
                        ...
                        <h3 class="tp-course-categories-title">Business</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".9s">
                        <div class="tp-course-categories-icon">
                           <span class="color-3">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M11.1998 4.80017H4.7998V11.2002H11.1998V4.80017Z" fill="#23344D" />
                        ...
                        <h3 class="tp-course-categories-title">Lifestyle</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <h3 class="tp-course-categories-title">Photography</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <h3 class="tp-course-categories-title">Music</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                  ...
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <h3 class="tp-course-categories-title">Accounting</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <h3 class="tp-course-categories-title">Marketing</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <h3 class="tp-course-categories-title">Architecture</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <a href="course-with-filter.php" class="tp-course-categories-item p-relative mb-25 wow fadeInUp" data-wow-delay=".9s">
                        ...
                        <h3 class="tp-course-categories-title">Art & Design</h3>
                        <p>15 Courses</p>
                     </a>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-6">
                  <div class="tp-banner-sm-2-wrap tp-banner-sm-2-bg-2 mb-60 wow fadeInUp" data-wow-delay=".5s">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-categories.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:08 GMT -->
</html>
