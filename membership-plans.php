...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/membership-plans.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:47 GMT -->
<head>
      <meta charset="utf-8">
                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list">
                           ...
                           <span class="color">Membership plans</span>
                        </div>
                        <h3 class="tp-breadcrumb__title white">Membership plans</h3>
                     </div>
                  </div>
               </div>
            </div>
         </section>
        <!-- membership breadcrumb end -->
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-pricing-5-item mb-40 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="tp-pricing-inner-btn">
                           <a class="tp-btn-4" href="contact.php">Join Course Plan</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-pricing-5-item active tp-pricing-inner-head mb-40 wow fadeInUp" data-wow-delay=".5s">
         ...
         <section class="banner-area pb-60">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6">
                     <div class="tp-banner-sm-2-wrap tp-banner-inner mb-60">
                  ...
                  <div class="col-lg-6">
                     <div class="tp-banner-sm-2-wrap tp-banner-sm-2-bg-2 tp-banner-inner mb-60">
