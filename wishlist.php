...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/wishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:52 GMT -->
<head>
   <meta charset="utf-8">
                     ...
                     <div class="tp-cart-list mb-45 mr-30">
                        <table class="table">
                           ...
                           <tbody>
                              <tr>
                                       <!-- img -->
                                 <td class="tp-cart-img"><a href="shop-details.php"> <img src="assets/img/shop/product/shop-product-1.jpg" alt=""></a></td>
                                 <!-- title -->
                                 <td class="tp-cart-title"><a href="shop-details.php">Nar Allt Ar Over</a></td>
                                 <!-- price -->
                              ...
                              <tr>
                                 <!-- img -->
                                 <td class="tp-cart-img"><a href="shop-details.php"> <img src="assets/img/shop/product/shop-product-2.jpg" alt=""></a></td>
                                 <!-- title -->
                                 <td class="tp-cart-title"><a href="shop-details.php">Under en rosa Himmel</a></td>
                                 <!-- price -->
                              ...
                              <tr>
                                 <!-- img -->
                                 <td class="tp-cart-img"><a href="shop-details.php"> <img src="assets/img/shop/product/shop-product-3.jpg" alt=""></a></td>
                                 <!-- title -->
                                 <td class="tp-cart-title"><a href="shop-details.php">Michael Connelly</a></td>
                                 <!-- price -->
                              ...
                              <tr>
                                    <!-- img -->
                                 <td class="tp-cart-img"><a href="shop-details.php"> <img src="assets/img/shop/product/shop-product-4.jpg" alt=""></a></td>
                                 <!-- title -->
                                 <td class="tp-cart-title"><a href="shop-details.php">Lycko Balansen</a></td>
                                 <!-- price -->
