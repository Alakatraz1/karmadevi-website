...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-analytics-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:30 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-analytics-overview.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div class="dashboader-area mb-25">
                        <div class="tp-dashboard-tab mb-60">
                           ...
                           <div class="tp-dashboard-tab-list">
                              <ul>
                                 <li>
                                    <a class="active" href="instructor-analytics-overview.php">Overview</a>
                                 </li>
                                 <li>
                                    <a href="instructor-analytics-course.php">Courses</a>
                                 </li>
                                 <li>
                                    <a href="instructor-analytics-earning.php">Earnings</a>
                                 </li>
                                 <li>
                                    <a href="instructor-analytics-statement.php">Statements</a>
                                 </li>
                                 <li>
                                    <a href="instructor-analytics-student.php">Students</a>
                                 </li>
                                 <li>
                                    <a href="#">Export</a>
                                 </li>
                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-4">
                              <div class="tp-fact-item d-flex align-items-center justify-content-between">
                                 ...
                                 <div class="tp-fact-icon">
                                    <span class="common-pale-purple"><img src="assets/img/dashboard/icon/fact/star.svg" alt="fact-icon"></span>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <div class="tpd-order-filter tpd-redio-style tmy-tab mb-30">
                                 <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item p-relative" role="presentation">
                                      <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-selected="true">
                           ...
                           <div class="col-lg-12">
                              <div class="tpd-dashboard-progress-box">
                                 ...
                                 <div class="tpd-dashboard-progress-body">
                                    ...
                                    <div class="tpd-dashboard-progress-graph" id="chart"></div>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    ...
                                    <div class="tpd-reviews-feedback">
                                       ...
                                       <span class="span">Nice Course</span>
                              ...
                              <li>
                                 <div class="tpd-table-row">
                                    ...
                                    <div class="tpd-reviews-feedback">
                                       ...
                                       <span class="span">Is Great Course!</span>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-analytics-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
</html>