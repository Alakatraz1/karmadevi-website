...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-with-tab.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:08 GMT -->
<head>
      <meta charset="utf-8">
                           ...
                           <div class="tp-pagination">
                              <nav>
                                 <ul class="justify-content-center">
                                    <li>
                                       <a href="course-with-tab.php"><svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                       <a href="course-with-tab.php">1</a>
                                    </li>
                                    <li>
                                       <span class="current">2</span>
                                    </li>
                                    <li>
                                       <a href="course-with-tab.php">3</a>
                                    </li>
                                    <li>
                                       <a href="course-with-tab.php" class="next page-numbers">
