...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-quiz-attempts-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:35 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-my-quiz.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-lg-6">
                                 <div class="tp-dashboard-section tpd-quiz-attempts">
                                    <div class="tpd-course-wrap">
                                       <a href="instructor-my-quiz.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="col-12">
                                 ...
                                 <div class="tpd-table mb-25">
                                    <ul>
                                       <li class="tpd-table-head">
                                          <div class="tpd-table-row">
                                             <div class="tpd-quiz-no-2">
                                                <h4 class="tpd-table-title">No</h4>
                                             </div>
                                             <div class="tpd-quiz-type-2">
                                                <h4 class="tpd-table-title">Type</h4>
                                             </div>
                                             <div class="tpd-quiz-date-3">
                                                <h4 class="tpd-table-title">Questions</h4>
                                             </div>
                                             <div class="tpd-quiz-tm-4">
                                       ...
                                       <li>
                                          <div class="tpd-table-row">
                                             ...
                                             <div class="tpd-quiz-tm-4">
                                                <h4 class="tpd-quiz-title-2-color">12</h4>
                                             </div>
                                             <div class="tpd-quiz-pm-2">
                                                <h4 class="tpd-quiz-title-2-color">12</h4>
                                             </div>
