...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-assignment.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:23 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-assignment.php">
                                          <span>
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="tp-dashboard-section">
                                 <h2 class="tp-dashboard-title">Assignments</h2>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                              ...
                              <div class="tpd-table li-hover-none mb-25">
                                 <ul>
                                    ...
                                    <li>
                                       <div class="tpd-table-row">
                                          <div class="tpd-assign-info">
                                             <h4 class="tpd-assign-title">What is design thinking's</h4>
                                             <div class="tpd-student-info">
                                                <p>Course: <span>Graphic</span></p>
                                             </div>
                                          </div>
                                          <div class="tpd-assign-mark">
                                    ...
                                    <li>
                                       <div class="tpd-table-row">
                                          <div class="tpd-assign-info">
                                             <h4 class="tpd-assign-title">Web Design System in Figma</h4>
                                             <div class="tpd-student-info">
                                                <p>Course: <span>Graphic</span></p>
                                             </div>
                                          </div>
                                    ...
                                    <li>
                                       <div class="tpd-table-row">
                                          <div class="tpd-assign-info">
                                             <h4 class="tpd-assign-title">Assignments 02</h4>
                                             <div class="tpd-student-info">
                                                <p>Course: <span>Graphic</span></p>
                                             </div>
                                          </div>
                                    ...
                                    <li>
                                       <div class="tpd-table-row">
                                          <div class="tpd-assign-info">
                                             <h4 class="tpd-assign-title">Assignments 03</h4>
                                             <div class="tpd-student-info">
                                                <p>Course: <span>Graphic</span></p>
                                             </div>
                                          </div>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-assignment.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:24 GMT -->
</html>