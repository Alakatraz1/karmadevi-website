...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-announcements.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:23 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <body>
     ...
     <div class="tp-search-area">
      ...
      <main class="tp-dashboard-body-bg">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-announcements.php">
                                          <span>
                                 ...
                                 <div class="tpd-announcement tpd-common-shadow d-flex align-items-center justify-content-between mb-70">
                                    <div class="tpd-announcement-info d-flex align-items-center">
                                       <div class="tpd-announcement-icon">
                                          <span><img src="assets/img/dashboard/icon/announcement-icon.svg" alt=""></span>
                                       </div>
                                    ...
                                    <div class="text-lg-end">
                                       <button class="tpd-border-btn active" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Add New Announcement</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div class="tpd-dashboard-select-course">
                                    <div class="tp-course-filter-select">
                                       <select class="wide">
                                          ...
                                          <option value="Latest">New Courses 2024</option>
                                          <option value="Popularity">Web Design System in Figma</option>
                                          <option value="Popularity">Interior design concepts Masterclass</option>
                                          <option value="Popularity">Graphic Design Masterclass</option>
                                          <option value="Popularity">Bootstrap 5 From Scratch</option>
                                       </select>
                                    </div>
                                 </div>
                              </div>
                                 ...
                                 <div class="tpd-dashboard-select-calender d-flex align-items-center justify-content-lg-end">                                          
                                    <div class="tpd-order-short-list mb-30">
                                       <div class="tp-course-filter-select">
                                          <select class="wide">
                                             ...
                                             <option value="Latest">SCFW</option>
                                             <option value="Popularity">QESC</option>
                                          </select>
                                       </div>
                                    </div>
                                    <div class="tpd-order-date-input mb-30 ml-10">
                                       <form action="#">
                                          ...
                                          <span>
                                             <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11.6667 2.33325H2.33333C1.59695 2.33325 1 2.93021 1 3.66659V12.9999C1 13.7363 1.59695 14.3333 2.33333 14.3333H11.6667C12.403 14.3333 13 13.7363 13 12.9999V3.66659C13 2.93021 12.403 2.33325 11.6667 2.33325Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.66602 1V3.66667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M4.33398 1V3.66667" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M1 6.33325H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                             </svg>
                                          </span>
                                       </form>
                                    </div>
                                 ...
                                 <div class="tpd-table tpd-announcement-table mb-45">
                                    <ul>
                                       ...
                                       <li>
                                          <div class="tpd-table-row">
                                             <div class="tpd-announcement-date">
                                                <h4 class="tpd-common-text">August 27, 2024</h4>
                                                <span class="tpd-announcement-time">6:01 am</span>
                                             </div>
                                             <div class="tpd-announcement-announcement">
                                                <h4 class="tpd-common-text">Web Design System in Figma</h4>
                                                <div class="tpd-course-wrap">
                                                   <span class="tpd-course-name">Course:</span>
                                                   <span class="tpd-course-title">Design Masterclass</span>
                                                </div>
                                             </div>
                                             <div class="tpd-announcement-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
         ...
         <!-- modal-start -->
         <div class="modal fade tpd-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
               <div class="modal-header">
                  ...
                  <h4 class="tpd-modal-title" id="exampleModalLabel">Design System in Figma</h4>
               ...
               <div class="modal-body">
                  <div class="tpd-modal-content">
                     <div class="tpd-modal-course">
                        <span>Course</span>
                        <h4 class="tpd-modal-course-title"><a href="#">App Development</a></h4>
                     </div>
                     <div class="tpd-modal-info">
                        <span>Published</span>
                        <h4 class="tpd-modal-date">September 13, 2023</h4>
                        <h4 class="tpd-modal-time">10.32am</h4>
                     </div>
                  </div>
               </div>
               <div class="modal-footer">
                  <div class="tpd-modal-btn">
                     <button type="button"  class="tpd-btn-cancel" data-bs-dismiss="modal">Cancel</button>
                  </div>
                  <div class="tpd-modal-btn-wrap">
                     <button type="button" class="tpd-btn-delete" data-bs-dismiss="modal">Delete</button>
                     <button type="button" class="tpd-btn-edit ml-10" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Edit</button>
                  </div>
               </div>
            </div>
            </div>
         ...
         <div class="modal fade tpd-modal-announcement" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggle" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
               <div class="modal-content">
                  <div class="modal-header">
                     <h4 class="tpd-modal-title" id="exampleModaltow">Edit Announcement</h4>
                     <button type="button" class="tpd-modal-btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span>
                           <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  <div class="modal-footer">
                     <button type="button" data-bs-dismiss="modal" aria-label="Close" class="tpd-btn-cancel">Cancel</button>
                     <button type="submit" class="tpd-btn-edit ml-10">Publish</button>
                  </div>
               </div>
            </div>
          </div>
