...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-course-edit.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
<head>
   <meta charset="utf-8">
   ...
   <body>
     ...
     <div class="tp-search-area">
      ...
      <main class="tp-dashboard-body-bg">
         ...
         <!-- dashboard-accordion-area-start -->
         <section class="dashboard-accordion-area mt-20 pb-120 p-relative z-index-1">
            <div class="container">
               <div class="row">
                  <div class="col-lg-8">
                        ...
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                           <div class="accordion-item">
                             ...
                             <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                               <div class="accordion-body course-edit">
                  ...
                  <div class="col-lg-4">
                     <div class="tpd-dashboard-course-edit-box">
                        <div class="tp-dashboard-section">
                           <h2 class="tp-dashboard-title">Select Courses</h2>
                        </div>
                        <div class="tpd-dashboard-course-edit mb-30">
                           <div class="tp-course-filter-select">
                              <select class="wide">
                                 <option value="Default">Select courses</option>
                                 <option value="Latest">Graphic Design</option>
                                 <option value="Popularity">Web Design</option>
                                 <option value="Popularity">Interior design</option>
                        ...
                        <div class="row tp-gx-10">
                           <div class="col-lg-6">
                              <div class="tp-dashboard-course courde-edit mb-65">
                                 ...
                                 <div class="tp-dashboard-course-content">
                                    ...
                                    <h4 class="tp-dashboard-course-title"><a href="course-details-2.php">Academic listening
                                       & Note-taking</a></h4>
                                    ...
                                    <div class="tp-dashboard-btn d-flex align-items-start">
                        ...
                        <div class="tpd-course-enroll-list course-edit">
                           <h2 class="tp-dashboard-title">Selection Overview</h2>
                           <ul>
                              <li>
                                 <span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none">
                                    <path opacity="0.4" d="M13.6 4V10.4H2.28C1.024 10.4 0 11.424 0 12.68V4C0 0.8 0.8 0 4 0H9.6C12.8 0 13.6 0.8 13.6 4Z" fill="#697089"/>
                                    <path d="M13.6 10.4V13.2C13.6 14.744 12.344 16 10.8 16H2.8C1.256 16 0 14.744 0 13.2V12.68C0 11.424 1.024 10.4 2.28 10.4H13.6Z" fill="#697089"/>
                                    <path d="M10 4.60002H3.6C3.272 4.60002 3 4.32802 3 4.00002C3 3.67202 3.272 3.40002 3.6 3.40002H10C10.328 3.40002 10.6 3.67202 10.6 4.00002C10.6 4.32802 10.328 4.60002 10 4.60002Z" fill="#697089"/>
                                    <path d="M7.6 7.39995H3.6C3.272 7.39995 3 7.12795 3 6.79995C3 6.47195 3.272 6.19995 3.6 6.19995H7.6C7.928 6.19995 8.2 6.47195 8.2 6.79995C8.2 7.12795 7.928 7.39995 7.6 7.39995Z" fill="#697089"/>
                                  </svg></span>4 Total Courses
                              </li>
                              <li>
                                 <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path opacity="0.4" d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16Z" fill="#697089"/>
                                    <path d="M10.9693 11.144C10.8653 11.144 10.7613 11.12 10.6653 11.056L8.18528 9.57598C7.56928 9.20798 7.11328 8.39998 7.11328 7.68798V4.40798C7.11328 4.07998 7.38528 3.80798 7.71328 3.80798C8.04128 3.80798 8.31328 4.07998 8.31328 4.40798V7.68798C8.31328 7.97598 8.55328 8.39998 8.80128 8.54398L11.2813 10.024C11.5693 10.192 11.6573 10.56 11.4893 10.848C11.3693 11.04 11.1693 11.144 10.9693 11.144Z" fill="#697089"/>
                                  </svg></span>300:00:00 Total Duration
                              </li>
                              <li>
                                 <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
                                    <path opacity="0.4" d="M8.39005 0.25H3.70723C1.03803 0.25 0 1.28803 0 3.95723V10.201C0 11.9961 0.975587 13.9082 3.70723 13.9082H8.39005C11.0593 13.9082 12.0973 12.8702 12.0973 10.201V3.95723C12.0973 1.28803 11.0593 0.25 8.39005 0.25Z" fill="#697089"/>
                                    <path d="M7.22119 6.59521C8.03155 6.59521 8.68847 5.93829 8.68847 5.12793C8.68847 4.31757 8.03155 3.66064 7.22119 3.66064C6.41083 3.66064 5.75391 4.31757 5.75391 5.12793C5.75391 5.93829 6.41083 6.59521 7.22119 6.59521Z" fill="#697089"/>
                                    <path d="M15.1415 2.5289C14.8215 2.36501 14.1503 2.17769 13.2371 2.81768L12.082 3.62937C12.0898 3.73863 12.0976 3.84009 12.0976 3.95716V10.2009C12.0976 10.318 12.082 10.4195 12.082 10.5287L13.2371 11.3404C13.721 11.6838 14.1425 11.7931 14.4781 11.7931C14.7668 11.7931 14.9932 11.715 15.1415 11.637C15.4615 11.4731 16 11.0282 16 9.91215V4.25374C16 3.13767 15.4615 2.6928 15.1415 2.5289Z" fill="#697089"/>
                                  </svg></span>4 Video Contents
                              </li>
                              <li>
                                 <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path opacity="0.4" d="M12.4432 3.83691C14.404 3.83691 16 5.48475 16 7.51006L16 11.5359C16 13.5563 14.408 15.2 12.4512 15.2L3.5584 15.2C1.5968 15.2 0 13.553 0 11.5276V7.5018C0 5.48145 1.5928 3.83691 3.5504 3.83691H4.3024L12.4432 3.83691Z" fill="#697089"/>
                                    <path d="M8.43831 10.8299L10.7655 8.45559C11.0055 8.2102 11.0055 7.81529 10.7639 7.5707C10.5223 7.32693 10.1327 7.32774 9.89271 7.57233L8.61831 8.87244L8.61831 0.625678C8.61831 0.280336 8.34231 0 8.00151 0C7.66151 0 7.38631 0.280336 7.38631 0.625678L7.38631 8.87244L6.11111 7.57233C5.87111 7.32774 5.48151 7.32693 5.23991 7.5707C5.11911 7.6934 5.05831 7.85348 5.05831 8.01437C5.05831 8.17363 5.11911 8.33371 5.23831 8.45559L7.56551 10.8299C7.68151 10.9477 7.83831 11.0144 8.00151 11.0144C8.16551 11.0144 8.32231 10.9477 8.43831 10.8299Z" fill="#697089"/>
                                  </svg></span>0 Downloadable Resources
                              </li>
                              <li>
                                 <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <path opacity="0.4" d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16Z" fill="#697089"/>
                                    <path d="M8 4.80005V8.00005" stroke="#697089" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M8 11.2H8.007" stroke="#697089" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                  </svg></span>2 Quiz Papers
                              </li>
                           </ul>
                        </div>
                     </div>
