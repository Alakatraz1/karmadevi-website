...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-my-quiz.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:29 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tpd-table mb-25">
                              <ul>
                                    ...
                                    <div class="tpd-table-row">
                                       ...
                                       <div class="tpd-quiz-details">
                                          <div class="tpd-quiz-details-btn">
                                             <a class="tpd-border-btn" href="instructor-quiz-attempts-2.php">Details</a>
                                          </div>
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info-sub">
                                          <span class="tpd-common-date">December 26, 2023</span>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info-sub">
                                          <span class="tpd-common-date">August 23, 2023</span>
                                 ...
                                 <li>
                                    <div class="tpd-table-row">
                                       <div class="tpd-quiz-info-sub">
                                          <span class="tpd-common-date">January 30, 2024</span>
                                          <h4 class="tpd-quiz-title">What is design thinking's</h4>
                                          <div class="tpd-student-info">
                                             <p><span>Student: </span> Benjamin Evalent</p>
                                          </div>
