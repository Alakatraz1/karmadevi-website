...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-history.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:38 GMT -->
<head>
   <meta charset="utf-8">
         ...
         <div class="row align-items-center">
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  ...
                  <h3 class="tp-breadcrumb__title color">History</h3>
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="col-lg-12">
                  <div class="tp-campus-choose-wrapper text-center">
                     ...
                     <div class="tp-campus-choose-content mb-10">
                        <h2 class="tp-campus-choose-title">Opened in 1896 to meet the growing educational needs of Melbourne’s west, the University early decades were quite challenging.</h2>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <section class="tp-history-area grey-bg pb-120">
         <div class="container">
            <div id="down" class="tp-history-box-wrapper p-relative">
               <div class="tp-history-box overlay-1 p-relative mb-180">
                  <div class="row align-items-center">
                     <div class="col-lg-2"> 
                        <div class="tp-history-year">
                           <h5 class="tp-history-year-title">1889</h5>
                        </div>
                     </div>
                     <div class="col-lg-5">
                     ...
                     <div class="col-lg-5">
                        <div class="tp-history-item-content">
                           <h2 class="tp-history-title line">1889</h2>
                           <p>Dr. Wright opens a new campus on thirty-two <br> acres on University Boulevard donated by Cabell <br> Outlaw, Jr. (Class of 1937).</p>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="tp-history-box p-relative mb-180">
                  <div class="row align-items-center">
                     <div class="col-lg-2">
                        <div class="tp-history-year">
                           <h5 class="tp-history-year-title">1960</h5>
                        </div>
                     </div>
                     <div class="col-lg-5">
                        <div class="tp-history-item-content-left">
                           <h2 class="tp-history-title">1938</h2>
                           <p>Dr. Wright opens a new campus on thirty-two <br> acres on University Boulevard donated by Cabell <br> Outlaw, Jr. (Class of 1937).</p>
                        </div>
                     </div>
                     <div class="col-lg-5">
               ...
               <div class="tp-history-box p-relative mb-180">
                  <div class="row align-items-center">
                     ...
                     <div class="col-lg-5">
                        <div class="tp-history-item-content">
                           <h2 class="tp-history-title">2012</h2>
                           <p>Dr. Wright opens a new campus on thirty-two <br> acres on University Boulevard donated by Cabell <br> Outlaw, Jr. (Class of 1937).</p>
                        </div>
                     </div>
                  </div>
               ...
               <div class="tp-history-box overlay-2 p-relative">
                  <div class="row align-items-center">
                     <div class="col-lg-2">
                        <div class="tp-history-year ankor">
                           <h5 class="tp-history-year-title">2023</h5>
                        </div>
                     </div>
                     <div class="col-lg-5">
                        <div class="tp-history-item-content-left">
                           <h2 class="tp-history-title">2023</h2>
                           <p>Dr. Wright opens a new campus on thirty-two <br> acres on University Boulevard donated by Cabell <br> Outlaw, Jr. (Class of 1937).</p>
                        </div>
                     </div>
                     <div class="col-lg-5">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-history.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:40 GMT -->
</html>