...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-continue-learning.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
<head>
   <meta charset="utf-8">
         ...
         <div class="tpd-dashboard-wrap-bg" data-background="assets/img/dashboard/bg/dashboard-bg-shape-1.jpg">
            ...
            <div class="tpd-continue-learning-wrapper">
               ...
               <div class="tpd-continue-learning-main">
                  ...
                  <!-- section-area-start -->
                  <div class="tpd-continue-learning-quiz pt-130">
                     <div class="container">
                        <div class="row justify-content-center">
                           <div class="col-lg-10 col-12">
                              <div class="tp-dashboard-section">
                                 <div class="tpd-continue-learning-content">
                                    <span>Quiz</span>
                                    <h4>Test your language basics with image</h4>

                                    <div class="tpd-continue-learning-q d-flex align-items-center">
                                       <div class="tpd-continue-learning-q-item">
                                          <p>Questions: <span>8</span></p>
                                       </div>
                                       <div class="tpd-continue-learning-q-item">
                                          <p>Quiz Time:  <span>13 Minutes</span></p>
                                       </div>
                                       <div class="tpd-continue-learning-q-item">
                                          <p>Total Marks: <span>3.00/8.00</span></p>
                                       </div>
                                       <div class="tpd-continue-learning-q-item">
                                          <p>Passing Marks: <span>6.40</span></p>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="tpd-table mb-25">
                                 <ul>
                                    ...
                                    <li>
                                       <div class="tpd-table-row">
                                          <div class="tpd-quiz-date">
                                             <h4 class="tpd-table-title">March 26, 2024</h4>
                                          </div>
                                          <div class="tpd-quiz-ques-3">
                                             <h4 class="tpd-table-title">2</h4>
                                          </div>
                                          <div class="tpd-quiz-tm-2">
                                             <h4 class="tpd-table-title">50</h4>
                                          </div>
                                          <div class="tpd-quiz-pm">
                                             <h4 class="tpd-table-title">20</h4>
                                          </div>
                                          <div class="tpd-quiz-ca">
                                             <h4 class="tpd-table-title">4</h4>
                                          </div>
                                          <div class="tpd-quiz-em">
                                             <h4 class="tpd-table-title">36</h4>
                                          </div>
                                          <div class="tpd-quiz-result">
                                          ...
                                          <div class="tpd-quiz-result">
                                             <a class="tpd-btn-details" href="#">Details</a>
                                          </div>
                                       </div>
                                    </li>
                                 </ul>
