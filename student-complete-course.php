...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/student-complete-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:34 GMT -->
<head>
   <meta charset="utf-8">
                                          ...
                                          <div class="row tp-gx-50">
                                             <div class="col-xl-6">
                                                <div class="tp-megamenu-courses-list">
                                                   <h4 class="tp-megamenu-courses-title">Filter One Toggle</h4>
                                                   <a href="course-categories.php">Course Categories</a>
                                                   <a href="course-with-filter.php">Filter One Toggle</a>
                                                   <a href="course-grid-categories.php">Course with Tab</a>
                                                   <a href="course-grid-categories.php">Course with Tab Two</a>
                                                   <a href="course-grid-2.php">Course Card Two</a>
                                                   <a href="course-with-filter.php">Course Card Three</a>
                                                </div>
                                             </div>
                                             <div class="col-xl-6">
                                                <div class="tp-megamenu-courses-list">
                                                   <h4 class="tp-megamenu-courses-title">Course With Sidebar</h4>
                                                   <a href="course-with-filter.php">Course With Sidebar</a>
                        ...
                        <div class="dashboader-area mb-30">
                           <div class="tp-dashboard-tab">
                              ...
                              <div class="tp-dashboard-tab-list">
                                 <ul>
                                    <li>
                                       <a href="student-enroll-course.php">Enrolled Courses <span>(56)</span></a>
                                    </li>
                                    <li>
                                       <a href="student-active-course.php">Active Courses <span>(21)</span></a>
                                    </li> 
                                    <li>
                                       <a class="active" href="student-complete-course.php">Completed Courses <span>(38)</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/student-complete-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:35 GMT -->
</html>