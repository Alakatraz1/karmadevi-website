...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-create-new-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:10 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-10">
                     <div class="tp-header-new-course-right d-flex justify-content-end">
                        ...
                        <span>
                           <a href="instructor-dashboard.php"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="tpd-new-course-wrap">
                           <div class="tpd-new-course-box">
                              ...
                              <div class="accordion" id="accordionPanelsStayOpenExample">
                                       ...
                                       <div class="tpd-new-course-box-2">
                                          ...
                                          <div class="tpd-input">
                                             ...
                                             <p><span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg></span>Number of students that can enrol in this course. Set 0 for no limits.</p>
                                          </div>
                                          <div class="tpd-input">
                                             ...
                                             <p><span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M8 5.19995V7.99995" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 10.8H8.007" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg></span>Course difficulty level</p>
                                          </div>
                                          <div class="tpd-input">
                                             ...
                                             <p><span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M8 5.19995V7.99995" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 10.8H8.007" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg></span>Make This Course Public. No enrollment required.</p>
                                          </div>
                                          <div class="tpd-input">
                                             <label>Q&A</label>
                                             <div class="switcher">
                                             ...
                                             <p class="m-0"><span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8 15C11.866 15 15 11.866 15 8C15 4.13401 11.866 1 8 1C4.13401 1 1 4.13401 1 8C1 11.866 4.13401 15 8 15Z" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 5.19995V7.99995" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8 10.8H8.007" stroke="#8F9195" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg></span>Enable Q&A section for your course</p>
                                          </div>
                                       </div>
                                          ...
                                          <div class="tpd-new-course-categories">
                                             <div class="tpd-new-course-select2">
                                                <div class="tpd-input">
                                                   ...
                                                   <select class="tpd-select2 form-select" multiple>
                                                      <option value="en" selected>The Science Behind Drawing</option>
                                                      <option value="fr" selected>Art</option>
                                                      <option value="de">Music</option>
                                                      <option value="pt">Photography</option>
                                                   </select>
                                                </div>
                                             </div>
                                             <div class="tpd-input">
                                             ...
                                             <div class="tpd-input course-file">
                                                ...
                                                <div class="tpd-new-course-file-content text-center" data-background="assets/img/dashboard/bg/select-file.png">
                                                   <div class="tpd-new-course-file-thumb mb-15">
                                                      <img src="assets/img/dashboard/bg/select-file-icon.png" alt="">
                                                   </div>
                                             ...
                                             <div class="tpd-input">
                                                ...
                                                <div class="tpd-select">
                                                   <select>
                                                      ...
                                                      <option>New Courses 2024</option>
                                                      <option>Web Design System in Figma</option>
                                                      <option>Graphic Design Masterclass</option>
                                                      <option>Interior design concepts Masterclass</option>
                                                   </select>
                                                </div>
                                             </div>
                                          </div>
                                   ...
                                   <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
                                     <div class="accordion-body">
                                       <div class="tpd-new-course-modal-btn">
                                          ...
                                          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-bs-whatever="@fat"><span><svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          ...
                                          <div class="modal-dialog">
                                             <div class="modal-content">
                                                <div class="modal-header">
                                                   <h4 class="tpd-modal-title" id="exampleModalLabel">Edit Announcement</h4>
                                                ...
                                                <div class="modal-body">
                                                   <form>
                                                      <div class="tpd-input-white mb-20">
                                                         ...
                                                         <input type="text" placeholder="Test Announcement">
                                                      </div>
                                                      <div class="tpd-input-white mb-20">
                                                         <label>Announcement Title</label>
                                                         <input type="text" placeholder="Test Announcement">
                                                ...
                                                <div class="modal-footer">
                                                   <button type="button" class="tpd-btn-cancel" data-bs-dismiss="modal" aria-label="Close">Cancel</button>
                                 ...
                                 <div class="accordion-item">
                                   <h2 class="accordion-header">
                                     <button class="accordion-button collapsed tpd-new-course-heading-title" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFour" aria-expanded="false" aria-controls="panelsStayOpen-collapseFour">
                                       Instructors
                                     </button>
                                   </h2>
                                     ...
                                     <div class="accordion-body">
                                       <div class="tpd-new-course-instructor">
                                          <div class="tpd-new-course-instructor-user d-flex align-items-center">
                                            ...
                                            <!-- modal-announcement-btn -->
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal2" data-bs-whatever="@fat"><span><svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                           ...
                                           </svg></span> Add Instructor</button>
                                          <!-- modal-announcement-btn-end -->
                                       </div>
                                     </div>
                                   </div>
                                 ...
                                 <div class="accordion-item">
                                   <h2 class="accordion-header">
                                     <button class="accordion-button collapsed tpd-new-course-heading-title" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFive" aria-expanded="false" aria-controls="panelsStayOpen-collapseFive">
                                       Course Attachments
                                     </button>
                                   </h2>
                                     ...
                                     <div class="accordion-body">
                                       <div class="tpd-new-course-box-1">
                                          <div class="tpd-input">
                                             ...
                                             <textarea placeholder="Write here the course benefits (One per line)"></textarea>
                                          </div>
                                          <div class="tpd-input">
                                             <label>Targeted Audience</label>
                                             <textarea placeholder="Specify the target audience that will benefit the most from the course."></textarea>
                                          </div>
                                          ...
                                          <div class="tpd-input height-auto">
                                             ...
                                             <textarea placeholder="A list of assets you will be providing for the students in this course (One per line)"></textarea>
                                          </div>
                                          <div class="tpd-input">
                                 ...
                                 <div class="accordion-item">
                                   <h2 class="accordion-header">
                                     <button class="accordion-button collapsed tpd-new-course-heading-title" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSeven" aria-expanded="false" aria-controls="panelsStayOpen-collapseSeven">
                                          ...
                                          <div class="row">
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate mb-30">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-1.png" alt="">
                                                </div>
                                             </div>
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate mb-30">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-2.png" alt="">
                                                </div>
                                             </div>
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate mb-30">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-3.png" alt="">
                                                </div>
                                             </div>
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-3.png" alt="">
                                                </div>
                                             </div>
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-4.png" alt="">
                                                </div>
                                             </div>
                                             <div class="col-lg-4 col-sm-6">
                                                <div class="tpd-new-course-cartificate">
                                                   <img src="assets/img/dashboard/cartificate/cartificate-5.png" alt="">
                                                </div>
                                             </div>
                                          </div>
                                       </div>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-create-new-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:12 GMT -->
</html>