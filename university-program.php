...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-program.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:19 GMT -->
<head>
   <meta charset="utf-8">
                        ...
                        <div class="tp-search-course-wrap">
                           ...
                           <div class="row">
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-search-course-item mb-30">
                                    <div class="tp-search-course-thumb mb-5">
                                       <a href="university-course-details.php"><img src="assets/img/course/search/search-1.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-search-course-content">
                                       ...
                                       <h4 class="tp-search-course-item-title"><a href="university-course-details.php">Affiliate marketing</a></h4>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-search-course-item mb-30">
                                    <div class="tp-search-course-thumb mb-5">
                                       <a href="university-course-details.php"><img src="assets/img/course/search/search-2.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-search-course-content">
                                       <div class="tp-search-course-star">
                                          <span><svg xmlns="http://www.w3.org/2000/svg" width="11" height="10" viewBox="0 0 11 10" fill="none">
                                       ...
                                       <h4 class="tp-search-course-item-title"><a href="university-course-details.php">Java Program</a></h4>
                                       <div class="tp-search-course-price">
                                          <span>$66.00</span>
                                       </div>
                                    </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-search-course-item mb-30">
                                    <div class="tp-search-course-thumb mb-5">
                                       <a href="university-course-details.php"><img src="assets/img/course/search/search-3.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-search-course-content">
                                       <div class="tp-search-course-star">
                                          <span><svg xmlns="http://www.w3.org/2000/svg" width="11" height="10" viewBox="0 0 11 10" fill="none">
                                       ...
                                       <h4 class="tp-search-course-item-title"><a href="university-course-details.php">Modern design</a></h4>
                                       <div class="tp-search-course-price">
                                          <span>$56.00</span>
                                       </div>
                                    </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-sm-6">
                                 <div class="tp-search-course-item mb-30">
                                    <div class="tp-search-course-thumb mb-5">
                                       <a href="university-course-details.php"><img src="assets/img/course/search/search-4.jpg" alt=""></a>
                                    </div>
                                    <div class="tp-search-course-content">
                                       <div class="tp-search-course-star">
                                          <span><svg xmlns="http://www.w3.org/2000/svg" width="11" height="10" viewBox="0 0 11 10" fill="none">
                                       ...
                                       <h4 class="tp-search-course-item-title"><a href="university-course-details.php">English course</a></h4>
                                       <div class="tp-search-course-price">
                                          <span>$36.00</span>
                                       </div>
                                    </div>
            ...
            <div class="row align-items-center">
               <div class="col-xxl-2 col-xl-2 col-6">
                  <div class="tp-header-logo">
                     <a href="index.php">
                        <img src="assets/img/logo/logo-breadcrumb.png" alt="logo">
                     </a>
                  </div>
               </div>
               ...
               <div class="col-xxl-3 col-xl-3 col-6">
                  <div class="tp-header-contact d-flex align-items-center justify-content-end">
                     ...
                     <div class="tp-header-inner-btn d-none d-md-block">
                        <a class="tp-btn-3" href="university-schedule.php">Plan a Visit</a>
                     </div>
   ...
   <main>
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Academic Programs</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">Academic Programs</h3>
               </div>
            </div>
         </div>
      </div>
      ...
      <section class="about-area pt-90 pb-90 grey-bg">
         <div class="container">
            <div class="row">
               <div class="col-12">
                  <div class="tp-about-4-wrapper mb-80">
                     ...
                     <div class="tp-about-4-btn">
                        <a class="tp-btn" href="university-about.php">Why Choose Acadia</a>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-undergraduate-program-box pb-85">
                     <div class="tp-undergraduate-program-heading" data-background="assets/img/history/undergraduate/heading-bg.png">
                        <h4 class="tp-undergraduate-program-title">
                           <span>
                              <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M21.4678 3.47313L14.1996 0.341915C13.133 -0.113972 11.5206 -0.113972 10.4539 0.341915L3.18568 3.47313C1.35002 4.26493 1.07715 5.34466 1.07715 5.92052C1.07715 6.49638 1.35002 7.57611 3.18568 8.36791L10.4539 11.4991C10.9872 11.7271 11.657 11.847 12.3268 11.847C12.9965 11.847 13.6663 11.7271 14.1996 11.4991L21.4678 8.36791C23.3035 7.57611 23.5764 6.49638 23.5764 5.92052C23.5764 5.34466 23.3159 4.26493 21.4678 3.47313Z" fill="white"/>
                           <path opacity="0.4" d="M12.3265 18.0495C11.8552 18.0495 11.3839 17.9536 10.9498 17.7736L2.59008 14.1745C1.31256 13.6226 0.320312 12.147 0.320312 10.7913C0.320312 10.2995 0.729615 9.90356 1.23814 9.90356C1.74667 9.90356 2.15597 10.2995 2.15597 10.7913C2.15597 11.4392 2.71411 12.279 3.33427 12.5429L11.694 16.142C12.0909 16.31 12.5498 16.31 12.9467 16.142L21.3064 12.5429C21.9265 12.279 22.4847 11.4512 22.4847 10.7913C22.4847 10.2995 22.894 9.90356 23.4025 9.90356C23.911 9.90356 24.3203 10.2995 24.3203 10.7913C24.3203 12.135 23.3281 13.6226 22.0505 14.1745L13.6909 17.7736C13.2692 17.9536 12.7978 18.0495 12.3265 18.0495Z" fill="white"/>
                           <path opacity="0.4" d="M12.3265 24C11.8552 24 11.3839 23.904 10.9498 23.724L2.59008 20.1249C1.21334 19.5371 0.320312 18.2054 0.320312 16.7418C0.320312 16.2499 0.729615 15.854 1.23814 15.854C1.74667 15.854 2.15597 16.2499 2.15597 16.7418C2.15597 17.4976 2.61489 18.1814 3.33427 18.4933L11.694 22.0924C12.0909 22.2604 12.5498 22.2604 12.9467 22.0924L21.3064 18.4933C22.0133 18.1934 22.4847 17.4976 22.4847 16.7418C22.4847 16.2499 22.894 15.854 23.4025 15.854C23.911 15.854 24.3203 16.2499 24.3203 16.7418C24.3203 18.2054 23.4273 19.5251 22.0505 20.1249L13.6909 23.724C13.2692 23.904 12.7978 24 12.3265 24Z" fill="white"/>
                              </svg>
                        </span> Major Programs</h4>
                     </div>
                        ...
                        <div class="row">
                           <div class="col-lg-4 col-md-6">
                              <div class="tp-undergraduate-program-list">
                                 <ul>
                                    <li><a href="university-course-details.php">Accounting <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Advertising <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Environmental Studies <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Art History <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Design <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Chemistry <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">International Business <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Economics <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                 </ul>
                              </div>
                           ...
                           <div class="col-lg-4 col-md-6">
                              <div class="tp-undergraduate-program-list">
                                 <ul>
                                    <li><a href="university-course-details.php">Engineering <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">English <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Computer Science <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Finance <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Architectur <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Fine Arts <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Biology <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Management <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                 </ul>
                              </div>
                           ...
                           <div class="col-lg-4 col-md-6">
                              <div class="tp-undergraduate-program-list">
                                 <ul>
                                    <li><a href="university-course-details.php">Marketing <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Environmental Science <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Politics <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Psychology <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Minors <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Comparative Literature  <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                    <li><a href="university-course-details.php">Philosophy <span><svg xmlns="http://www.w3.org/2000/svg" width="7" height="12" viewBox="0 0 7 12" fill="none">
                                       <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-opacity="1" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                     </svg></span></a></li>
                                 </ul>
                              </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="tp-undergraduate-program-box">
                     <div class="tp-undergraduate-program-heading" data-background="assets/img/history/undergraduate/heading-bg.png">
                        <h4 class="tp-undergraduate-program-title"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                           <path d="M16.7993 7.2002H7.19922V16.8002H16.7993V7.2002Z" fill="white"/>
                           <path opacity="0.4" d="M3.60002 23.9998C5.58003 23.9998 7.20003 22.3798 7.20003 20.3998V16.7998H3.60002C1.62001 16.7998 0 18.4198 0 20.3998C0 22.3798 1.62001 23.9998 3.60002 23.9998Z" fill="white"/>
                           <path opacity="0.4" d="M3.60002 7.20003H7.20003V3.60002C7.20003 1.62001 5.58003 0 3.60002 0C1.62001 0 0 1.62001 0 3.60002C0 5.58003 1.62001 7.20003 3.60002 7.20003Z" fill="white"/>
                           <path opacity="0.4" d="M16.8008 7.20003H20.4008C22.3808 7.20003 24.0008 5.58003 24.0008 3.60002C24.0008 1.62001 22.3808 0 20.4008 0C18.4208 0 16.8008 1.62001 16.8008 3.60002V7.20003Z" fill="white"/>
                           <path opacity="0.4" d="M20.4008 23.9998C22.3808 23.9998 24.0008 22.3798 24.0008 20.3998C24.0008 18.4198 22.3808 16.7998 20.4008 16.7998H16.8008V20.3998C16.8008 22.3798 18.4208 23.9998 20.4008 23.9998Z" fill="white"/>
                         </svg></span> Minors Programs</h4>
                     </div>
                     <div class="tp-undergraduate-program-content">
                        <div class="row">
                           <div class="col-lg-4 col-md-6">
      ...
      <!-- cta-area-start -->
      <section class="cta-area tp-cta-bg grey-bg" data-background="assets/img/cta/cta-bg-2.jpg">
         <div class="container">
               ...
               <div class="col-xxl-10 col-lg-9">
                  <div class="tp-cta-wrapper d-flex align-items-center">
                     <div class="tp-cta-logo">
                        <a href="university-course-details.php"><img src="assets/img/cta/cta-logo-1.png" alt=""></a>
                     </div>
               ...
               <div class="col-xxl-2 col-lg-3">
                  <div class="tp-cta-btn-wrap">
                     <div class="tp-cta-btn text-lg-end">
                        <a class="tp-btn" href="apply.php">Apply Now <span><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-xl-4 col-lg-3 col-sm-6">
                     <div class="tp-footer-widget tp-footer-col-1 mb-30">
                        <div class="tp-footer-widget-logo mb-20 tp-header-logo">
                           <a href="index.php"><img src="assets/img/logo/logo-red.png" alt=""></a>
                        </div>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-program.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:20 GMT -->
</html>