...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-with-tab-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:08 GMT -->
<head>
      <meta charset="utf-8">
                     ...
                     <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="tp-course-grid-box tp-tab">
                           <ul class="nav nav-tabs" id="filtertab-1" role="tablist">
                              <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="art-tab" data-bs-toggle="tab" data-bs-target="#art" type="button" role="tab" aria-controls="art" aria-selected="true">
                                 Art &amp; Design
                                </button>
                              </li>
                              <li class="nav-item" role="presentation">
                              ...
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="m-tab" data-bs-toggle="tab" data-bs-target="#m" type="button" role="tab" aria-controls="m" aria-selected="false">
                                    Marketing
                                 </button>
                              </li>
                           </ul>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb">
                                          <a href="course-details-2.php"><img class="course-sky" src="assets/img/course/course-list/course-thumb-3.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                             <span>Art & Design</span>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb">
                                          <a href="course-details-2.php"><img class="course-lightblue" src="assets/img/course/course-list/course-thumb-2.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                             <span>Art & Design</span>
                     ...
                     <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="tp-course-grid-box tp-tab">
                           <ul class="nav nav-tabs" id="filtertab-2" role="tablist">
                              <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="art-2-tab" data-bs-toggle="tab" data-bs-target="#art-2" type="button" role="tab" aria-controls="art-2" aria-selected="true">
                                 Art &amp; Design
                                </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="business-2-tab" data-bs-toggle="tab" data-bs-target="#business-2" type="button" role="tab" aria-controls="business-2" aria-selected="false">
                                  Business
                                 </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="data-2-tab" data-bs-toggle="tab" data-bs-target="#data-2" type="button" role="tab" aria-controls="data-2" aria-selected="false">
                                    Data Science
                                 </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="finance-2-tab" data-bs-toggle="tab" data-bs-target="#finance-2" type="button" role="tab" aria-controls="finance-2" aria-selected="false">
                                    Finance
                                 </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="style-2-tab" data-bs-toggle="tab" data-bs-target="#style-2" type="button" role="tab" aria-controls="style-2" aria-selected="false">
                                    Lifestyle
                                 </button>
                              </li>
                              <li class="nav-item" role="presentation">
                                 <button class="nav-link" id="m-2-tab" data-bs-toggle="tab" data-bs-target="#m-2" type="button" role="tab" aria-controls="m-2" aria-selected="false">
                                    Marketing
                                 </button>
                              </li>
                           </ul>
                        ...
                        <div class="tab-content" id="Content">
                           ...
                           <div class="tab-pane fade" id="business-2" role="tabpanel" aria-labelledby="business-2-tab">
                              <div class="tp-course-filter-item mb-25 d-flex">
                                 <div class="tp-course-filter-thumb">
                                    <a href="course-details-2.php">
                                       <img class="course-sky" src="assets/img/course/course-list/course-thumb-3.jpg" alt="">
                           ...
                           <div class="tab-pane fade" id="data-2" role="tabpanel" aria-labelledby="data-2-tab">
                              <div class="tp-course-filter-item mb-25 d-flex">
                                 <div class="tp-course-filter-thumb">
                                    <a href="course-details-2.php">
                                       <img src="assets/img/course/course-list/course-thumb-4.jpg" alt="">
                           ...
                           <div class="tab-pane fade" id="finance-2" role="tabpanel" aria-labelledby="finance-2-tab">
                              <div class="tp-course-filter-item mb-25 d-flex">
                                 <div class="tp-course-filter-thumb">
                                    <a href="course-details-2.php">
                                       <img src="assets/img/course/course-list/course-thumb-5.jpg" alt="">
                           ...
                           <div class="tab-pane fade" id="style-2" role="tabpanel" aria-labelledby="style-2-tab">
                           ...
                           <div class="tab-pane fade" id="m-2" role="tabpanel" aria-labelledby="m-2-tab">
                              <div class="tp-course-filter-item mb-25 d-flex">
                                 <div class="tp-course-filter-thumb">
                                    <a href="course-details-2.php">
                                       <img src="assets/img/course/course-list/course-thumb-4.jpg" alt="">
                           ...
                           <div class="tp-pagination">
                              <nav>
                                 <ul class="justify-content-center">
                                    <li>
                                       <a href="course-with-tab-list.php"><svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                       <a href="course-with-tab-list.php">1</a>
                                    </li>
                                    <li>
                                       <span class="current">2</span>
                                    </li>
                                    <li>
                                       <a href="course-with-tab-list.php">3</a>
                                    </li>
                                    <li>
                                       <a href="course-with-tab-list.php" class="next page-numbers">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-with-tab-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:09 GMT -->
</html>
