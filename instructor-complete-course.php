...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-complete-course.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:32 GMT -->
<head>
   <meta charset="utf-8">
                        ...
                        <div class="dashboader-area mb-30">
                           <div class="tp-dashboard-tab">
                              ...
                              <div class="tp-dashboard-tab-list">
                                 <ul>
                                    <li>
                                       <a href="instructor-enroll-course.php">Enrolled Courses <span>(56)</span></a>
                                    </li>
                                    <li>
                                       <a href="instructor-active-course.php">Active Courses <span>(21)</span></a>
                                    </li>
                                    <li>
                                       <a class="active" href="instructor-complete-course.php">Completed Courses <span>(38)</span></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                                    ...
                                    <div class="tp-dashboard-course-content">
                                       ...
                                       <div class="tp-dashboard-progress">
                                          ...
                                          <div class="progress" role="progressbar" aria-label="Example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
                                             <div class="progress-bar wow fadeInLeft" data-wow-duration=".9s" data-wow-delay=".3s" data-width="100%"></div>
                                          </div>
                                       </div>
