...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-q&a.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:28 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                       <a class="active" href="instructor-q%26a.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="col-lg-6">
                                       <div class="tpd-dashboard-qa-tab mb-30">
                                          <div class="nav nav-tabs tpd-dashboard-qa-tab-bg" id="myTab" role="tablist">
                                               <button class="nav-link active monthly" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Student</button>
                                               <button class="nav-link yearly" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Instructor</button>
                                             <div class="test"></div>
                                           </div>
                                       </div>
                                    </div>
                                             ...
                                             <li>
                                                <div class="tpd-table-row">
                                                   <div class="tpd-instructor-qa-student">
                                                      <div class="tpd-reviews-profile d-flex align-items-center">
                                                         ...
                                                         <div class="tpd-reviews-text">
                                                            ...
                                                            <span class="tpd-common-date">June 11, 2021 at 6:01 am</span>
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="tpd-instructor-qa-question">
                                                      <h4 class="tpd-common-text">Hello!</h4>
                                                      <div class="tpd-course-wrap">
                                                         <span class="tpd-course-name">Course:</span>
                                                         <span class="tpd-course-title">New Course</span>
                                                      </div>
                                                   </div>
                                                   <div class="tpd-instructor-qa-reply">
                                                      <h4 class="tpd-common-text">2</h4>
                                                   </div>
                                                   <div class="tpd-instructor-qa-status">
                                                   ...
                                                   <div class="tpd-instructor-qa-btn">
                                                      <a  class="tpd-border-btn" href="#">Reply</a>
                                                   </div>
                                                            ...
                                                            <button>
                                                               <span>
                                                                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
                                                                     <path d="M2.2 1H11.8C12.46 1 13 1.54 13 2.2V9.4C13 10.06 12.46 10.6 11.8 10.6H2.2C1.54 10.6 1 10.06 1 9.4V2.2C1 1.54 1.54 1 2.2 1Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                     <path d="M13 2.19995L7 6.39995L1 2.19995" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                   </svg>
                                                               </span>
                                                               Mark as Unread 
                                                            </button>
