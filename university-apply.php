...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-apply.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:25 GMT -->
<head>
   <meta charset="utf-8">
            ...
            <div class="col-sm-12">
               <div class="tp-breadcrumb__content">
                  <div class="tp-breadcrumb__list inner-after">
                     ...
                     <span class="white">Admissions</span>
                     <span class="white">How to Apply</span>
                  </div>
                  <h3 class="tp-breadcrumb__title color">How to Apply</h3>
               </div>
            </div>
         </div>
      </div>
                  ...
                  <div class="tp-campus-choose-wrapper text-center">
                     <div class="tp-campus-choose-btn admission wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="tp-campus-choose-content mb-10">
                           <h2 class="tp-campus-choose-title">Items with an asterisk are required. <br>
                              The application form saves your progress, <br> so don’t worry about completing <br>
                              it in one sitting!</h2>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="tp-apply-thumb wow fadeInUp" data-wow-delay=".5s">
                  <img src="assets/img/course/details/apply-thumb.jpg" alt="">
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="col-lg-8">
               <div id="down" class="tp-apply-process-wrapper wow fadeInUp" data-wow-delay=".5s">
                  ...
                  <div class="tp-apply-process-box">
                     <h4 class="tp-apply-process-subtitle"><span>1</span>Complete Application Form</h4>
                     <p>The University of Acadia uses Apply web for the processing of graduate applications. <br>
                        Proceed to the link below to create an Apply web account, submit an application review a <br>
                        submitted application, and access post-submission functionality.</p>
                     <a class="tp-btn mt-30" href="university-application-form.php">Application Form</a>
                  </div>
                  <div class="tp-apply-process-box">
                     <h4 class="tp-apply-process-subtitle"><span>2</span>Confirmation of Application</h4>
                     <p>Admissions requirements vary by program. Please consult the <a href="university-apply.php">program website</a> to verify which
                        information is required to complete the application.</p>
                  </div>
                  <div class="tp-apply-process-box">
                     <h4 class="tp-apply-process-subtitle"><span>3</span>Application Review</h4>
                     <p>QRC will review your application to confirm you meet our requirements. If so, you will then be asked
                        to complete an interview as part of the review process.</p>
                  </div>
                  <div class="tp-apply-process-box">
                     <h4 class="tp-apply-process-subtitle"><span>4</span>Application Interview</h4>
                     <p>Interviews are usually completed over the phone with a member of the Academic Team.
                        The purpose of the interview is to get to know you better, hear about your future plans, understand
                        why you are interested in the course.</p>
                  </div>
                  <div class="tp-apply-process-box">
                     <h4 class="tp-apply-process-subtitle"><span>5</span>Payment of Fees</h4>
                     <p>At the end of the application, you will be required to pay the registration fee and the testing fee
            ...
            <div class="col-lg-8">
               <div class="tp-apply-requirement-box">
                  ...
                  <div class="tp-apply-requirement-bullet mb-55">
                     <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                      ...
                      </svg></span> You can be admitted at any time during the academic year.</p>
                     <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                        <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                        <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                      </svg></span> If English is not your first language, you will need to demonstrate English <br> 
                      language proficiency equivalent to with a minimum of 5.5 in each <br>
                      band and 6.0 in speaking.</p>
                     <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                        <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                        <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                      </svg></span> Contact information for one teacher (or two, maximum) who will complete <br>  
                      the Teacher Evaluation form.</p>
                     <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                        <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                        <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                      </svg></span> Open to students 18 years and over at course commencement</p>
                     <p><span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="13" viewBox="0 0 16 13" fill="none">
                        <path d="M1.92006 3.56018H0.64002C0.286729 3.56018 0 3.75123 0 3.98739V10.8142C0 11.0494 0.286729 11.2404 0.64002 11.2404H1.92006C2.27335 11.2404 2.56008 11.0494 2.56008 10.8132V3.98643C2.56008 3.75123 2.27335 3.56018 1.92006 3.56018Z" fill="#161613"/>
                        <path d="M10.4462 10.19C10.4462 9.95097 10.3866 9.72544 10.2815 9.52751C10.6581 9.27232 10.9057 8.84094 10.9057 8.35196C10.9057 8.11257 10.8464 7.88698 10.7416 7.68911C11.1179 7.43387 11.3652 7.00268 11.3652 6.51396C11.3652 6.36811 11.3432 6.2274 11.3023 6.09495H14.0818C14.8633 6.09495 15.5008 5.45754 15.5008 4.67595C15.5008 3.89435 14.8633 3.25694 14.0818 3.25694H8.70373L8.98679 3.03179C9.61071 2.54701 9.70937 1.65176 9.21681 1.04119C8.73502 0.423294 7.84836 0.320604 7.23789 0.804966L2.76642 3.94416L2.55371 4.09349V4.35338V10.4721V10.6598L2.6772 10.8011C3.10105 11.2862 3.72517 11.609 4.43222 11.609H9.02723C9.80883 11.609 10.4462 10.9716 10.4462 10.19Z" stroke="#161613"/>
                      </svg></span> Spiritual Formation Program Requirements</p>
                  </div>
                  <div class="tp-apply-requirement-btn">
                     <a class="tp-btn" href="university-campus.php">Request a campus tour</a>
                  </div>
               </div>
            </div>
            <div class="col-lg-4">
               <div class="tp-apply-dedline-box">
                  ...
                  <div class="tp-apply-dedline-wrapper">
                     <div class="tp-apply-dedline-wrap d-flex align-items-center justify-content-between">
                     ...
                     <div class="tp-apply-dedline-wrap b-none d-flex align-items-center justify-content-between">
                        <div class="tp-apply-dedline-content">
                           <span>Current Continuing</span>
                           <p>March 1</p>
                        </div>
                        <div class="tp-apply-dedline-date">
                           <p>All continuing</p>
                     ...
                     <div class="tp-apply-btn">
                        <a class="tp-btn" href="university-financial.php">Visit Financial Aid</a>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="tp-footer-4-bottom tp-footer-inner-bottom">
            <div class="container">
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="tp-footer-4-copyright text-center">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/university-apply.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:28:26 GMT -->
</html>