               ...
               <div class="col-lg-10">
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-contact-info-item mb-30">
                           <div class="tp-contact-info-icon">
                              <span style="background-color:#f00e83"><svg width="18" height="15" viewBox="0 0 18 15" fill="none"
                                    ...
                                    <path
                                       ...
                                       stroke-linejoin="round" />
                                    <path d="M17 2.6001L9 8.2001L1 2.6001" stroke="#fff" stroke-width="2"
                                       stroke-linecap="round" stroke-linejoin="round" />
                                 </svg></span>
                           </div>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-contact-info-item mb-30">
                           <div class="tp-contact-info-icon">
                              <span style="background-color:#069546"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17"
                                    fill="none">
                                    <path
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-contact-info-item mb-30">
                           <div class="tp-contact-info-icon">
                              <span style="background-color:#3471cc"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                    fill="none">
