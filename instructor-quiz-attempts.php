...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/instructor-quiz-attempts.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:22 GMT -->
<head>
   <meta charset="utf-8">
               ...
               <div class="row">
                           ...
                           <div class="tp-user-menu">
                              <nav>
                                 <ul>
                                    ...
                                    <li>
                                      <a class="active" href="instructor-quiz.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                       <a href="instructor-certificate.php">
                                          <span>
                                             <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-lg-9">
                     ...
                     <div class="tpd-content-layout">
                              ...
                              <div class="col-lg-6">
                                 <div class="tp-dashboard-section tpd-quiz-attempts">
                                    <div class="tpd-course-wrap">
                                       <a href="instructor-quiz.php"><span><svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M11 6H1" stroke="#6B7194" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                          <path d="M6 11L1 6L6 1" stroke="#6B7194" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg></span> Back</a>
                                       <span class="tpd-course-name">Course:</span>
                                       <span class="tpd-course-title">3D Motion Design</span>   
                                    </div>
                                    <h2 class="tp-dashboard-title">Quiz Test 02</h2>
                                    <div class="tpd-quiz-time">
                                       <ul>
                                          <li>
                                             <div class="tpd-quiz-time-item">
                                                <p><span>Quiz Time:</span> 0 Minutes</p>
                                             </div>
                                          </li>
                                          <li>
                                             <div class="tpd-quiz-time-item">
                                                <p><span>Attempt Time:</span> 21 Seconds</p>
                                             </div>
                                          </li>
                                       </ul>
                                    </div>
                        ...
                        <!-- course-area-start -->
                        <div class="tpd-quiz-attempts-area mb-60">
                           <div class="row">
                              <div class="col-12">
                                 <div class="tpd-table">
                                    <ul>
                                       <li class="tpd-table-head">
                                          <div class="tpd-table-row">
                                             <div class="tpd-quiz-date">
                                                <h4 class="tpd-table-title">Date</h4>
                                             </div>
                                             <div class="tpd-quiz-ques-2">
                                                <h4 class="tpd-table-title">Qus</h4>
                                             </div>
                                             <div class="tpd-quiz-tm-2">
                                                <h4 class="tpd-table-title">TM</h4>
                                             </div>
                                             <div class="tpd-quiz-pm">
                                                <h4 class="tpd-table-title">PM</h4>
                                             </div>
                                             <div class="tpd-quiz-ca">
                                                <h4 class="tpd-table-title">CA</h4>
                                             </div>
                                             <div class="tpd-quiz-em">
                                                <h4 class="tpd-table-title">EM</h4>
                                             </div>
                                       ...
                                       <li>
                                          <div class="tpd-table-row">
                                             <div class="tpd-quiz-date">
                                                <h4 class="tpd-quiz-title-2">March 26, 2024</h4>
                                             </div>
                                             <div class="tpd-quiz-ques-2">
                                                <h4 class="tpd-quiz-title-2">2</h4>
                                             </div>
                                             <div class="tpd-quiz-tm-2">
                                                <h4 class="tpd-quiz-title-2">50</h4>
                                             </div>
                                             <div class="tpd-quiz-pm">
                                                <h4 class="tpd-quiz-title-2">20</h4>
                                             </div>
                                             <div class="tpd-quiz-ca">
                                                <h4 class="tpd-quiz-title-2">4</h4>
                                             </div>
                                             <div class="tpd-quiz-em">
                                                <h4 class="tpd-quiz-title-2">36</h4>
                                             </div>
                                             <div class="tpd-quiz-result">
                                                <div class="tpd-badge-item">
                                                   <span class="tpd-badge sucess">Pass</span>
                                                </div>
                                             </div>
                                          </div>
                                       </li>
                        ...
                        <div class="tpd-quiz-attempts-area">
                           <div class="row">
                              <div class="col-12">
                                 <h2 class="tp-dashboard-title">Quiz Overview</h2>
                                       ...
                                       <li class="tpd-table-head">
                                          <div class="tpd-table-row">
                                             ...
                                             <div class="tpd-quiz-tm-3">
                                                <h4 class="tpd-table-title">Given Answer</h4>
                                             </div>
                                             ...
                                             <div class="tpd-quiz-em">
                                                <h4 class="tpd-table-title">Review</h4>
                                             </div>
                                          </div>
                                       </li>
                                       <li>
                                          <div class="tpd-table-row">
                                             <div class="tpd-quiz-no">
                                                <h4 class="tpd-quiz-title-2-color">1</h4>
                                             </div>
                                             <div class="tpd-quiz-type">
                                                <div class="tpd-action-btn">
                                                   <button class="nohover">
                                                      <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                         <rect width="26" height="26" rx="4" fill="#3C66F9" />
                                                         <circle cx="13" cy="13" r="7" stroke="white" stroke-width="2" />
                                                         <path d="M13 21C11.9494 21 10.9091 20.7931 9.93853 20.391C8.96793 19.989 8.08601 19.3997 7.34315 18.6569C6.60028 17.914 6.011 17.0321 5.60896 16.0615C5.20693 15.0909 5 14.0506 5 13C5 11.9494 5.20693 10.9091 5.60896 9.93853C6.011 8.96793 6.60028 8.08601 7.34315 7.34315C8.08601 6.60028 8.96793 6.011 9.93853 5.60896C10.9091 5.20693 11.9494 5 13 5L13 13V21Z" fill="white" />
                                                       </svg>
                                                      <span class="tpd-action-tooltip">Short Answer</span>
                                                   </button>
                                                </div>
                                             </div>
                                             <div class="tpd-quiz-date-2">
                                                <h4 class="tpd-quiz-title-2-color">Questions 02</h4>
                                             </div>
                                             <div class="tpd-quiz-tm-3">
                                                <h4 class="tpd-quiz-title-2-color">False</h4>
                                             </div>
                                             <div class="tpd-quiz-pm-2">
                                                <h4 class="tpd-quiz-title-2-color">False</h4>
                                             </div>
                                             ...
                                             <div class="tpd-quiz-em">
                                                <div class="tpd-quiz-em-box d-flex">
                                                   <div class="tpd-action-approv">
                                                      <button>
                                                         <svg xmlns="http://www.w3.org/2000/svg" width="13" height="10" viewBox="0 0 13 10" fill="none"><path d="M11.1186 1.75L4.61861 8.25L1.66406 5.29545" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                         </svg>
                                                      </button>
                                                   </div>
                                                   <div class="tpd-action-approv">
                                                      <button class="reject">
                                                         <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 1L1 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M1 1L9 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                         </svg>
                                                      </button>
                                                   </div>
                                                </div>
