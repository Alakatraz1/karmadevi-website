...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-with-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:05 GMT -->
<head>
      <meta charset="utf-8">
                              ...
                              <div class="row">
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-pink" src="assets/img/course/course-thumb-1.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">Interior design Masterclass</a>
                                          </h4>
                                       ...
                                       <div class="tp-course-btn">
                                          <a href="course-details-3.php">Preview this Course</a>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-lightblue" src="assets/img/course/course-thumb-2.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                             <span>Business</span>
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">Starting seo as your based business</a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-sky" src="assets/img/course/course-thumb-3.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                             <span>Marketing</span>
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">Grow personal financial security</a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-pink" src="assets/img/course/course-thumb-5.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">The complete guide to build application</a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-sky" src="assets/img/course/course-thumb-4.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                             <span>Art & Design</span>
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">Computer science mathematical</a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-thumb sidebar">
                                          <a href="course-details-3.php"><img class="course-lightblue" src="assets/img/course/course-thumb-6.jpg" alt=""></a>
                                       </div>
                                       <div class="tp-course-content">
                                          <div class="tp-course-tag mb-10">
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">Machine learning hands-on python </a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="tp-course-item p-relative fix mb-30">
                                       ...
                                       <div class="tp-course-content">
                                          ...
                                          <h4 class="tp-course-title">
                                             <a href="course-details-3.php">The complete guide to build restful </a>
                                          </h4>
                                          <div class="tp-course-rating d-flex align-items-end justify-content-between">
                                             <div class="tp-course-rating-star">
                                                <p>5.0<span> /5</span></p>
                              ...
                              <div class="row">
                                 <div class="tp-course-filter-item mb-25 d-flex">
                                    <div class="tp-course-list-thumb">
                                       <a href="course-details-3.php"><img class="course-pink" src="assets/img/course/course-sidebar/course-sidebar-1.png" alt=""></a>
                                    </div>
                                    <div class="tp-course-filter-content">
                                       ...
                                       <h4 class="tp-course-list-title">
                                          <a href="course-details-3.php">Interior design concepts Masterclass</a>
                                       </h4>
                                 ...
                                 <div class="tp-course-filter-item mb-25 d-flex">
                                    ...
                                    <div class="tp-course-filter-content">
                                       ...
                                       <h4 class="tp-course-list-title">
                                          <a href="course-details-3.php">Master of Business Administration</a>
                                       </h4>
                                       <div class="tp-course-filter-meta">
                                 ...
                                 <div class="tp-course-filter-item mb-25 d-flex">
                                    ...
                                    <div class="tp-course-filter-content">
                                       ...
                                       <h4 class="tp-course-list-title">
                                          <a href="course-details-3.php">Web Design Training with Elementor</a>
                                       </h4>
                                       <div class="tp-course-filter-meta">
                                 ...
                                 <div class="tp-course-filter-item mb-25 d-flex">
                                    ...
                                    <div class="tp-course-filter-content">
                                       ...
                                       <h4 class="tp-course-list-title">
                                          <a href="course-details-3.php">People Making Music with Other</a>
                                       </h4>
                                       <div class="tp-course-filter-meta">
                                 ...
                                 <div class="tp-course-filter-item mb-25 d-flex">
                                    ...
                                    <div class="tp-course-filter-content">
                                       ...
                                       <h4 class="tp-course-list-title">
                                          <a href="course-details-3.php">Making Music with Other People</a>
                                       </h4>
                                       <div class="tp-course-filter-meta">
                           ...
                           <div class="tp-pagination">
                              <nav>
                                 <ul class="justify-content-center">
                                    <li>
                                       <a href="course-with-sidebar.php"><svg width="15" height="13" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                       <a href="course-with-sidebar.php">1</a>
                                    </li>
                                    <li>
                                       <span class="current">2</span>
                                    </li>
                                    <li>
                                       <a href="course-with-sidebar.php">3</a>
                                    </li>
                                    <li>
                                       <a href="course-with-sidebar.php" class="next page-numbers">
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/course-with-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:29:07 GMT -->
</html>
