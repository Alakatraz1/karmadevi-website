...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:27:27 GMT -->
<head>
      <meta charset="utf-8">
   ...
   <body>
      ...
      <div class="cartmini__area">
         <div class="cartmini__wrapper p-relative d-flex justify-content-between flex-column">
            ...
            <div class="cartmini__top-wrapper">
               ...
               <div class="cartmini__shipping home-5">
               ...
               <div class="cartmini__widget">
                  <div class="cartmini__widget-item">
                     ...
                     <div class="cartmini__content">
                        <h5 class="cartmini__title home-5"><a href="shop-details.php">Nar Allt Ar Over</a></h5>
                        <div class="cartmini__price-wrapper">
                           <span class="cartmini__price home-5">$108.00</span>
                           <span class="cartmini__quantity">x2</span>
                        </div>
                     </div>
                     <a href="#" class="cartmini__del home-5"><i class="fa-regular fa-xmark"></i></a>
                  </div>
               </div>
               <!-- for wp -->
               <!-- if no item in cart -->
            ...
            <div class="cartmini__checkout">
               ...
               <div class="cartmini__checkout-btn home-5">
      ...
      <header class="header-area tp-header-transparent">
         <div id="header-sticky" class="tp-header-5">
            <div class="container-fluid">
               <div class="row align-items-center">
                  <div class="col-xl-2 col-lg-6 col-6">
                     <div class="tp-header-5-logo tp-header-logo">
                        <a href="index.php">
                           <img class="logo-1" src="assets/img/logo/logo-white.png" alt="logo">
                           <img class="logo-2" src="assets/img/logo/logo-black.png" alt="logo">
                        </a>
                     </div>
                  </div>
                     ...
                     <div class="main-menu">
                        <nav class="tp-main-menu-content">
                           <ul>
                                       ...
                                       <div class="row tp-gx-20">
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index.php">University Classic</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-3.php">Online Course</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-4.php">Kids Education</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-5.php">Gym Coaching</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-6.php">High School</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="shop.php">Books Shop</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-7.php">Online Academy</a></h4>
                                             </div>
                                          </div>
                                          <div class="col-xl-3 col-md-6 col-12">
                                             <div class="tp-megamenu-home-item text-center p-relative mb-30">
                                                ...
                                                <h4 class="tp-megamenu-home-title"><a class="yellow" href="index-8.php">Course Hub</a></h4>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                                ...
                                                <div class="row tp-gx-90">
                                                   <div class="col-xl-3 ">
                                                      <div class="tp-megamenu-fullwidth-list">
                                                         ...
                                                         <ul>
                                                            <li><a class="yellow" href="about.php">About Us</a></li>
                                                            <li><a class="yellow" href="university-about.php">University About</a></li>
                                                            <li><a class="yellow" href="university-campus.php">Campus</a></li>
                                                            <li><a class="yellow" href="university-mission.php">Mission & Values</a></li>
                                                            <li><a class="yellow" href="university-history.php">History</a></li>
                                                            <li><a class="yellow" href="university-leadership.php">Our Leadership</a></li>
                                                         </ul>
                                                      </div>
                                                   </div>
                                                   <div class="col-xl-6 ">
                                                         ...
                                                         <div class="tp-megamenu-fullwidth-list-wrap">
                                                            <div class="row">
                                                               <div class="col-xl-6 col-12">
                                                                  <ul>
                                                                     <li><a class="yellow" href="event.php">Events</a></li>
                                                                     <li><a class="yellow" href="event-details.php">Event Details</a></li>
                                                                     <li><a class="yellow" href="instructor.php">Instructor</a></li>
                                                                     <li><a class="yellow" href="my-profile.php">Profile</a></li>
                                                                     <li><a class="yellow" href="become-instructor.php">Become a Instructor</a></li>
                                                                     <li><a class="yellow" href="up-coming.php">Maintenance</a></li>
                                                                  </ul>
                                                               </div>
                                                               <div class="col-xl-6 col-12">
                                                                  <ul>
                                                                     <li><a class="yellow" href="contact.php">Contact Us</a></li>
                                                                     <li><a class="yellow" href="membership-plans.php">Membership plans</a></li>
                                                                     <li><a class="yellow" href="faq.php">FAQs</a></li>
                                                                     <li><a class="yellow" href="privacy-policy.php">Privacy Policy</a></li>
                                                                     <li><a class="yellow" href="error.php">404 Page</a></li>
                                                                  </ul>
                                                               </div>
                                                            </div>
                                                         </div>
                                                   ...
                                                   <div class="col-xl-3 ">
                                                      <div class="tp-megamenu-fullwidth-list">
                                                         ...
                                                         <ul>
                                                            <li><a class="yellow" href="shop-grid.php">Shop</a></li>
                                                            <li><a class="yellow" href="shop-details.php">Single Product</a></li>
                                                            <li><a class="yellow" href="cart.php">Cart Page</a></li>
                                                            <li><a class="yellow" href="wishlist.php">Wishlist page</a></li>
                                                            <li><a class="yellow" href="my-account.php">My Account</a></li>
                                                            <li><a class="yellow" href="login.php">Login & Register</a></li>
                                                         </ul>
                                                      </div>
                                                   </div>
                                                </div>
                              ...
                              <li class="has-dropdown">
                                 <a href="blog-stories.php">Blog</a>
                                 <ul class="tp-submenu">
                           ...
                           <button>
                              <span>
                                 <svg width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.40947 9.14901C10.6598 9.14901 12.484 7.32479 12.484 5.07451C12.484 2.82422 10.6598 1 8.40947 1C6.15918 1 4.33496 2.82422 4.33496 5.07451C4.33496 7.32479 6.15918 9.14901 8.40947 9.14901Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M15.4102 17.298C15.4102 14.1444 12.2728 11.5937 8.41016 11.5937C4.54752 11.5937 1.41016 14.1444 1.41016 17.298" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg>
                              </span>
                           </button>
                           <div class="tp-header-user-box">
                              <div class="tp-header-user-content">
                                 ...
                                 <div class="tp-header-user-list">
                                    <ul>
                                       <li><a href="instructor-dashboard.php"><span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <li><a href="instructor-profile.php">
                                          <span>
                                       ...
                                       <li><a href="instructor-quiz-attempts.php"><span><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <li><a href="instructor-order.php"><span><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <li><a href="instructor-q%26a.php"><span><svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       ...
                                       <li>
                                          <a href="instructor-setting-profile.php">
                                             <span>
      ...
      <main>
         ...
         <section class="slider-area tp-slider-5-wrap">
            <div class="slider tp-slider-5-active">
               <div class="tp-slider-5-bg" data-background="assets/img/slider/slider-5-bg-1.jpg">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-7">
                           <div class="tp-slider-5-content">
                              <span>Welcome to Acadia</span>
                              <h2 class="tp-slider-5-title">Unlock Your <br> full potential 
                                 <span>
                                    with
                                    <img src="assets/img/shape/bottom-line/slider-5-line-1.svg" alt="">
                                 </span>
                                 Gym Coaching</h2>
                              <div class="tp-slider-5-btn">
                                 <a class="tp-btn-white" href="contact.php">JOIN OUR GYM</a>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="tp-slider-5-bg" data-background="assets/img/slider/slider-5-bg-2.jpg">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-7">
                           <div class="tp-slider-5-content">
                              <span>Welcome to Acadia</span>
                              <h2 class="tp-slider-5-title">Everything For Office & <span>School <img src="assets/img/shape/bottom-line/slider-5-line-1.svg" alt=""></span> Supplies </h2>
                              <div class="tp-slider-5-btn">
                                 <a class="tp-btn-white" href="contact.php">JOIN OUR GYM</a>
                              </div>
                           </div> 
               ...
               <div class="tp-slider-5-bg" data-background="assets/img/slider/slider-5-bg-3.jpg">
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-7">
                           <div class="tp-slider-5-content">
                              <span>Welcome to Acadia</span>
                              <h2 class="tp-slider-5-title">Build Education Website <span>Using <img src="assets/img/shape/bottom-line/slider-5-line-1.svg" alt=""></span> Acadia</h2>
                              <div class="tp-slider-5-btn">
                                 <a class="tp-btn-white" href="contact.php">JOIN OUR GYM</a>
                              </div>
                           </div>
            ...
            <div class="slider tp-slider-5-arrow">
               <div class="tp-slider-5-next">
                  <div class="tp-slider-5-thumb-sm">
                     <img src="assets/img/slider/slider-5-sm-1.jpg" alt="">
                     <span>01</span>
               ...
               <div class="tp-slider-5-next">
                  <div class="tp-slider-5-thumb-sm">
                     <img src="assets/img/slider/slider-5-sm-2.jpg" alt="">
                     <span>02</span>
                     <div class="tp-slider-5-next-hover"></div>
                  </div>
               </div>
               <div class="tp-slider-5-next">
                  <div class="tp-slider-5-thumb-sm">
                     <img src="assets/img/slider/slider-5-sm-3.jpg" alt="">
                     <span>03</span>
                     <div class="tp-slider-5-next-hover"></div>
                  </div>
               </div>
         ...
         <!-- services-area-start -->
         <section class="service-area tp-service-5-wrap mb-105">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-service-5-item text-center">
                        <div class="tp-service-5-icon">
                           <span><img src="assets/img/icon/service/service-5-icon-1.svg" alt=""></span>
                        </div>
                        <div class="tp-service-5-content">
                           <h4 class="tp-service-5-title"><a href="#">Build Confidence</a></h4>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-service-5-item text-center">
                        <div class="tp-service-5-icon">
                           <span><img src="assets/img/icon/service/service-5-icon-2.svg" alt=""></span>
                        </div>
                        <div class="tp-service-5-content">
                           <h4 class="tp-service-5-title"><a href="#">Boost Your Mood</a></h4>
                           <p>Here are some tips and activities that can help boost your mood <br>
                              and promote a positive mindset.</p>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-service-5-item service-5-border text-center">
                        <div class="tp-service-5-icon">
                           <span><img src="assets/img/icon/service/service-5-icon-3.svg" alt=""></span>
                        </div>
                        <div class="tp-service-5-content">
                           <h4 class="tp-service-5-title"><a href="#">Increase Energy Levels</a></h4>
                           <p>Here are some tips and activities that can help boost your mood <br>
                              and promote a positive mindset.</p>
                        </div>
                     </div>
               ...
               <div class="row wow fadeInUp" data-wow-delay=".3s">
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        ...
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-1.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Strength Training  
                                 <span>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-2.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Functional Fitness  
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-3.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Powerful and Strong  
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-4.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Youth & Teen Fitness  
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-5.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Online Coaching  
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-6.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Core & Flexibility 
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-7.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Mind-Body Balance  
                                 <span>
                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M1 7H13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M7 1L13 7L7 13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6">
                     <div class="tp-category-5-item mb-60">
                        <div class="tp-category-5-hover"></div>
                        <div class="tp-category-5-thumb">
                           <img src="assets/img/category/category-5-thumb-8.jpg" alt="">
                        </div>
                        <div class="tp-category-5-content">
                           <h4 class="tp-category-5-title">
                              <a href="course-with-filter.php">Mind-Body Balance  
         ...
         <!-- brand-area-start -->
         <section class="brand-area theme-bg-2 tp-brand-5-bg mb-120">
            <div class="container">
               <div class="row">
                  <div class="col-12">
                     <div class="tp-brand-5-section text-center">
                        <h4 class="tp-brand-5-title">The renovator is proudly partnered with</h4>
                     </div>
                  </div>
               </div>
               <div class="row">
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-1.png" alt="">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-2.png" alt="">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-3.png" alt="">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-4.png" alt="">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-5.png" alt="">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="tp-brand-5-item">
                                 <img src="assets/img/brand/brand-5-logo-6.png" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row tp-gx-60">
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           ...
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-1.jpg" alt="">
                           ...
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/course/course-5-avatar-1.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Complete Fitness Trainer: Beginner to Advanced</a></h4>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           <div class="tp-course-5-hover"></div>
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-2.jpg" alt="">
                              <div class="tp-course-5-price">
                           ...
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/teacher/teacher-1.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Lazy dancer Ballet Burn – 30
                                 Days Programmed.</a></h4>
                              <div class="tp-course-meta">
                                 <span>
                                    <span>
                                       <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           <div class="tp-course-5-hover"></div>
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-3.jpg" alt="">
                              <div class="tp-course-5-price">
                                 <span>$87</span>
                              </div>
                           </div>
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/teacher/teacher-2.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Seven Reasons You Fall In
                                 Love With Gym.</a></h4>
                              <div class="tp-course-meta">
                                 <span>
                                    <span>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           <div class="tp-course-5-hover"></div>
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-4.jpg" alt="">
                              <div class="tp-course-5-price">
                                 <span>$54</span>
                              </div>
                           </div>
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/teacher/teacher-3.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Fitness trainer: Gym Workout
                                 & Body Building</a></h4>
                              <div class="tp-course-meta">
                                 <span>
                                    <span>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           <div class="tp-course-5-hover"></div>
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-5.jpg" alt="">
                              <div class="tp-course-5-price">
                                 <span>$38</span>
                              </div>
                           </div>
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/teacher/teacher-4.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Benefits Gym Change Your
                                 Perspective.</a></h4>
                              <div class="tp-course-meta">
                                 <span>
                                    <span>
                     ...
                     <div class="col-lg-4 col-md-6">
                        <div class="tp-course-5-item mb-60">
                           <div class="tp-course-5-hover"></div>
                           <div class="tp-course-5-thumb">
                              <img src="assets/img/course/course-5-thumb-6.jpg" alt="">
                              <div class="tp-course-5-price">
                                 <span class="free">Free</span>
                              </div>
                           </div>
                           <div class="tp-course-5-content">
                              <div class="tp-course-5-avatar d-flex align-items-center">
                                 <span><img src="assets/img/teacher/teacher-6.png" alt=""></span>
                                 <h5 class="tp-course-5-avatar-title"><a href="#">Benjamin Evalent</a></h5>
                              </div>
                              <h4 class="tp-course-5-title"><a href="course-details-2.php">Taboos about Gym you Should
                                 Share On Twitter.</a></h4>
                              <div class="tp-course-meta">
                                 <span>
                                    <span>
                                       <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="row">
                  <div class="col-12">
                     <div class="tp-course-5-btn text-center wow fadeInUp" data-wow-delay=".5s">
                        <a class="tp-btn-4" href="course-with-filter.php">View all courses</a>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <!-- video-area-start -->
         <div class="tp-video-5-area tp-video-hover tp-video-5-bg" data-background="assets/img/bg/video-5-bg-1.jpg">
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-12">
                     <div class="tp-video-5-btn tp-video-button">
                        ...
                        <span class="tp-m-play-inner">
                           <svg class="tp-circle-svg" xmlns="http://www.w3.org/2000/svg" width="152" height="152" viewBox="0 0 152 152">
                              <path id="tp-cicle-path-934" fill="#F0EC51" d="M18,76a58,58,0,1,1,58,58A58,58,0,0,1,18,76"></path>
         ...
         <!-- pricing-area-start -->
         <section class="pricing-area pt-115 pb-80">
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-6">
                     <div class="tp-section-5 text-center mb-65">
                        <h5 class="tp-section-5-subtitle mb-10">Pricing plan</h5>
                        <h3 class="tp-section-5-title">Membership Plans</h3>
               ...
               <div class="row">
                     ...
                     <div class="tp-pricing-5-item mb-40 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tp-pricing-5-head">
                           <div class="tp-pricing-5-head-text">
                              <h4 class="tp-pricing-5-head-title">Silver Membership</h4>
                              <span>Valid for 2 months</span>
                           </div>
                           <h2 class="tp-pricing-5-price"><span>$</span> 24 <b>/ Month</b></h2>
                        </div>
                        ...
                        <div class="tp-pricing-5-btn">
                           <a class="tp-btn-4" href="membership-plans.php">Join Course Plan</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-pricing-5-item active mb-40 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-pricing-5-head">
                           <div class="tp-pricing-5-head-text">
                              <h4 class="tp-pricing-5-head-title">Gold Membership</h4>
                              <span>Valid for 12 months</span>
                           </div>
                           <h2 class="tp-pricing-5-price"><span>$</span> 54 <b>/ Month</b></h2>
                        </div>
                        <div class="tp-pricing-5-list">
                           <ul>
                              <li>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-pricing-5-item mb-40 wow fadeInUp" data-wow-delay=".7s">
                        <div class="tp-pricing-5-head">
                           <div class="tp-pricing-5-head-text">
                              <h4 class="tp-pricing-5-head-title">Platinum Membership</h4>
                              <span>Perfect for committed trainers</span>
                           </div>
                           <h2 class="tp-pricing-5-price"><span>$</span> 64 <b>/ Month</b></h2>
                        </div>
                        <div class="tp-pricing-5-list">
                           <ul>
                              <li>
         ...
         <!-- trainer-area-start -->
         <section class="trainer-area pb-110 pt-110" data-bg-color="#FAF6F3">
            <div class="container">
               <div class="row">
                  <div class="col-lg-5">
                     <div class="tp-trainer-5-wrapper mb-40 wow fadeInUp" data-wow-delay=".3s">
                        <div class="tp-section-5 mb-30">
                           ...
                           <p>Alienum phaedrum torquatos nec eu, vis detraxitssa <br> ericuliser ex, nihil expetendis in mei.</p>
                        </div>
                        <div class="tp-trainer-5-btn">
                           <a class="tp-btn-4" href="university-leadership.php">Get started</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                           ...
                           <div class="swiper-wrapper">
                              <div class="swiper-slide tp-trainer-5-item">
                                 <div class="tp-trainer-5-thumb">
                                    <img src="assets/img/teacher/trainer-5-thumb-1.jpg" alt="">
                                 </div>
      
                                 <div class="tp-trainer-5-box">
                                    <div class="tp-trainer-5-content">
                                       <div class="tp-trainer-5-info">
                                          <h4 class="tp-trainer-5-title"><a href="my-profile.php">Patrick James</a></h4>
                              ...
                              <div class="swiper-slide tp-trainer-5-item">
                                 <div class="tp-trainer-5-thumb">
                                    <img src="assets/img/teacher/trainer-5-thumb-2.jpg" alt="">
                                 </div>
                                 <div class="tp-trainer-5-box">
                                    <div class="tp-trainer-5-content">
                                       <div class="tp-trainer-5-info">
                                          <h4 class="tp-trainer-5-title"><a href="my-profile.php">Zoe Powell</a></h4>
                                          <span>Coach</span>
                                       </div>
                                       <div class="tp-trainer-5-social">
                                          <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                              ...
                              <div class="swiper-slide tp-trainer-5-item">
                                 <div class="tp-trainer-5-thumb">
                                    <img src="assets/img/teacher/trainer-5-thumb-3.jpg" alt="">
                                 </div>
                                 <div class="tp-trainer-5-box">
                                    <div class="tp-trainer-5-content">
                                       <div class="tp-trainer-5-info">
                                          <h4 class="tp-trainer-5-title"><a href="my-profile.php">William Smithi</a></h4>
         ...
         <section class="banner-area">
            <div class="container-fluid p-0">
               <div class="row g-0">
                  <div class="col-lg-6">
                     <div class="tp-banner-5-item" data-background="assets/img/banner/banner-5-bg-1.jpg">
                        <div class="tp-banner-5-content text-center">
                           <span>Claim your</span>
                           <h2 class="tp-banner-5-title">Free 7 days Pass</h2>
                           <p>Enjoy a workout on us! You will happy for sure.</p>
                           <div class="tp-banner-5-btn">
                              <a class="tp-btn-5" href="contact.php">Get started</a>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6">
                     <div class="tp-banner-5-item" data-background="assets/img/banner/banner-5-bg-2.jpg">
                        <div class="tp-banner-5-content text-center">
                           <span>Call Us</span>
                           <h2 class="tp-banner-5-title"><a href="tel:0123456">402 911 2804</a></h2>
                           <p>If we can help you on your journey! Or check out our FAQ’s</p>
                           <div class="tp-banner-5-btn">
                              <a class="tp-btn-4" href="contact.php">CONTACT US</a>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                     <div class="tp-footer-widget tp-footer-5-col-1 mb-30">
                        <div class="tp-footer-widget-logo mb-20 tp-header-logo">
                           <a href="index.php"><img src="assets/img/logo/logo-black-2.png" alt=""></a>
                        </div>
                  ...
                  <div class="col-xl-2 col-lg-3 col-md-6 col-sm-6">
                     <div class="tp-footer-widget tp-footer-5-col-2 mb-30">
                  ...
                  <div class="col-xl-2 col-lg-3 col-md-5 col-sm-5">
                     <div class="tp-footer-widget tp-footer-5-col-3 mb-30">
                        ...
                        <div class="tp-footer-newsletter-wrap">
                           ...
                           <form action="#">
                              <div class="tp-footer-newsletter-wrapper mb-30">
                                 <div class="tp-footer-newsletter-input tp-footer-5-newsletter-input">
                                    <input type="email" placeholder="Your email">
                                 </div>
                                 <div class="tp-footer-5-newsletter-submit">
                                    <button class="tp-btn-4">Subscribe</button>
                                 </div>
                              </div>
                           </form>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index-5.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:27:42 GMT -->
</html>