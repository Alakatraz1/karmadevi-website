...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:26:44 GMT -->
<head>
      <meta charset="utf-8">
                                          ...
                                          <div class="row tp-gx-50">
                                             <div class="col-xl-3 col-12">
                                                <div class="tp-megamenu-academics-list">
                                                   ...
                                                   <a href="course-categories.php">Off- campus learning</a>
                                                   <a href="course-categories.php">Online Education</a>
                     ...
                     <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-12">
                        <div class="tp-hero-2-content">
                           ...
                           <h2 class="tp-hero-2-title wow fadeInUp" data-wow-delay=".5s">Best digital 
                               <span>Online <img class="wow bounceIn" data-wow-duration="1.5s" data-wow-delay=".4s" src="assets/img/unlerline/hero-2-svg-1.svg" alt=""></span> 
                           Courses</h2>
                           ...
                           <div class="tp-hero-2-btn wow fadeInUp" data-wow-delay=".9s">
                              <a class="tp-btn-border" href="course-with-filter.php">Find Courses 
                                 <span>
                        ...
                        <div class="tp-hero-2-course p-relative wow fadeInUp" data-wow-delay=".5s">
                           <div class="tp-course-item p-relative fix mb-30">
                              ...
                              <div class="tp-course-thumb">
                                 <a href="course-details-2.php"><img class="course-lightblue" src="assets/img/course/course-thumb-1.jpg" alt=""></a>
                              </div>
            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <a href="course-categories.php" class="tp-category-item mb-25 wow fadeInUp" data-wow-delay=".3s">
                  ...
                  <div class="col-lg-3 col-md-4 col-sm-6">
                     <a href="course-categories.php" class="tp-category-item mb-25 wow fadeInUp" data-wow-delay=".5s">
                        <div class="tp-category-icon">
                        ...
                        <div class="row align-items-center">
                           <div class="col-lg-6 col-md-4">
                              <div class="tp-live-thumb p-relative">
                                 <img src="assets/img/live/live-thumb-1.jpg" alt="">
                                 ...
                                 <div class="tp-live-teacher">
                                    <div class="tp-live-teacher-info d-flex align-items-center">
                                       <div class="tp-live-teacher-thumb">
                                          <img src="assets/img/teacher/live-2-teacher-1.png" alt="">
                                       </div>
                  ...
                  <div class="swiper-wrapper align-items-end">
                     <div class="swiper-slide">
                        <div class="tp-team-2-item">
                           ...
                           <div class="tp-team-2-content">
                              <h4 class="tp-team-2-title"><a href="my-profile.php">Leslie Alexander</a></h4>
                     ...
                     <div class="swiper-slide">
                        <div class="tp-team-2-item">
                           ...
                           <div class="tp-team-2-content">
                              <h4 class="tp-team-2-title"><a href="my-profile.php">Annette Black</a></h4>
                              <span>Teaches Interior Design</span>
                           </div>
                        </div>
                     </div>
                     <div class="swiper-slide">
                        <div class="tp-team-2-item">
                           ...
                           <div class="tp-team-2-content">
                              <h4 class="tp-team-2-title"><a href="my-profile.php">Kathryn Murphy</a></h4>
                              <span>Teaches Interior Design</span>
                           </div>
                        </div>
                     </div>
                     <div class="swiper-slide">
                        <div class="tp-team-2-item">
                           ...
                           <div class="tp-team-2-content">
                              <h4 class="tp-team-2-title"><a href="my-profile.php">Mina Hollace</a></h4>
                              <span>Teaches Interior Design</span>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="tp-footer-widget tp-footer-2-col-1 mb-30">
                           ...
                           <div class="tp-footer-contact">
                              <div class="tp-footer-btn">
                                 <a class="tp-btn-round" href="contact.php">Contact Us 
                                    <span>
                                       <svg width="14" height="11" viewBox="0 0 14 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <path d="M8.71533 1L13 5.28471L8.71533 9.56941" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
...
<!-- Mirrored from html.hixstudio.net/acadia-prev/acadia/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Nov 2024 07:27:05 GMT -->
</html>